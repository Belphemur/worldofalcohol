...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9ed41459bc5_21167523',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9ed41459bc5_21167523')) {function content_54c9ed41459bc5_21167523($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Indonesia Alcohols: Discover the best alcohols (Arrack) from Indonesia</title>
        <meta name="description" content="Discover and share local Arrack, Beer from Indonesia">
		<meta name="keywords" content="Indonesia alcohols, alcohol Indonesia, Arrack Indonesia, Beer Indonesia, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Indonesia Alcohols: Discover best Arrack from Indonesia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Indonesia.png"/>
		 
		<meta property="og:description" content="Discover and share local Arrack, Beer from Indonesia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/indonesia-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Indonesia</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
									<li class="menu_id">
						<a href="#Arrack (1)" class="item_link">Arrack (1)</a>
						<ul class="submenu">
														<li><a href="batavia-arrack-van-oosten_indonesia-arrack">Batavia-Arrack van Oosten</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Beer (2)" class="item_link">Beer (2)</a>
						<ul class="submenu">
														<li><a href="gold-lion-extra-stout_indonesia-beer">Gold Lion Extra Stout</a></li>
														<li><a href="storm-beer-black-moon-iron-stout_indonesia-beer">Storm Beer Black Moon Iron Stout</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Indonesia.png" /><br>
Capital: <b>Jakarta</b><br>
Population: <b>255,461,700</b><br>
<div id="country_details">
Surface: <b>1,904,569 km²</b><br>
Currency: <b>IDR</b><br>
Motto: <b>Bhinneka Tunggal Ika (Old Javanese, « Unity in diversity »)</b><br><br>
Drinking age: <b>21</b><br>
National Alcohols: <b>Arrack</b><br>
</div>
</div>
	</div>
</div>
<div class="ink-alert basic warning all-60 small-100">
<h5>Do you know any other local alcohol from Indonesia ? Feel free to share it with us </h5>
<a href="submit.php?country=indonesia" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Indonesia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="batavia-arrack-van-oosten_indonesia-arrack">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/batavia-arrack-van-oosten_795.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Batavia-Arrack van Oosten</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="storm-beer-black-moon-iron-stout_indonesia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/storm-beer-black-moon-iron-stout_134.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Storm Beer Black Moon Iron Stout</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="gold-lion-extra-stout_indonesia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/NA.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Gold Lion Extra Stout</figcaption>
		</figure></a>                        
		</div>
	</div>
