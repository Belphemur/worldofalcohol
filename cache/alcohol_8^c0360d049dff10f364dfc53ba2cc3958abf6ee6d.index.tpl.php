...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c908a4a86979_69558293',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c908a4a86979_69558293')) {function content_54c908a4a86979_69558293($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Domaine Mamounia Coteaux de Mascara - Wine Red from El Bordj, Algeria</title>
        <meta name="description" content="Discover and share more Beer, Wine from Algeria">
		<meta name="keywords" content="Domaine Mamounia Coteaux de Mascara, Domaine Mamounia Coteaux de Mascara Domaine El Bordj, Algeria Wine, Algeria Red Wine, Domaine Mamounia Coteaux de Mascara 12 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Domaine Mamounia Coteaux de Mascara</b></a></li>
	</ul>
	</nav>
</header>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Wine<br>
		Genre: Red<br>
		Brewery: Domaine El Bordj<br>
		Brewed in: El Bordj, Algeria<br><br>
		ABV: <b>12</b> %
	...
	<div class="xlarge-30 large-30 medium-50 small-100"> 
		<form class="ink-form">
			<fieldset>
				<legend>Rate this Wine</legend>
				<div id="my-progress-bar" class="ink-progress-bar grey" data-req-id="f8a39b807f650e03d88dc8a91e75e072" data-start-value="">
				  <span class="caption"> (0 Ratings)</span>
				  					<div class="bar red"></div>
				  				</div>
				<div class="control-group">
					<p class="label">Have you tried this Wine already? Let us know your opinion</p>
					<div id="rating_options">
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="8" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="8" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="8" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="8" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="8" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
