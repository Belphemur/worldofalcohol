...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c8126c75aad0_06396675',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c8126c75aad0_06396675')) {function content_54c8126c75aad0_06396675($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Ghana Alcohols: Discover the best alcohols (Akpeteshie) from Ghana</title>
        <meta name="description" content="Discover and share local Beer from Ghana">
		<meta name="keywords" content="Ghana alcohols, alcohol Ghana, Beer Ghana, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Ghana</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="guinness-foreign-extra-stout_ghana-beer">Guinness Foreign Extra Stout</a></li>
														<li><a href="club-gold-export-lager_ghana-beer">Club Gold Export Lager</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Ghana.png" /><br>
Capital: <b>Accra</b><br>
Population: <b>27,043,093</b><br>
<div id="country_details">
Surface: <b>238,533 km²</b><br>
Currency: <b>GHS</b><br>
Motto: <b>« Freedom and Justice »</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Akpeteshie</b><br>
</div>
</div>
...
<h5>Do you know any other local alcohol from Ghana ? Feel free to share it with us </h5>
<a href="submit.php?country=ghana" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Ghana </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="guinness-foreign-extra-stout_ghana-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/guinness-foreign-extra-stout_113.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Guinness Foreign Extra Stout</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="club-gold-export-lager_ghana-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/NA.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Club Gold Export Lager</figcaption>
		</figure></a>                        
		</div>
	</div>
