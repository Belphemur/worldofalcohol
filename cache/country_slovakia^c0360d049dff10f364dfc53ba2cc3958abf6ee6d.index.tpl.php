...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca1cd340f472_95890472',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca1cd340f472_95890472')) {function content_54ca1cd340f472_95890472($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Slovakia Alcohols: Discover the best alcohols (Borovicka, Tatratea) from Slovakia</title>
        <meta name="description" content="Discover and share local Beer, Liquor from Slovakia">
		<meta name="keywords" content="Slovakia alcohols, alcohol Slovakia, Beer Slovakia, Liquor Slovakia, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Slovakia Alcohols: Discover best Borovicka, Tatratea from Slovakia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Slovakia.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Liquor from Slovakia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/slovakia-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Slovakia</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="hellstork-kraken-ipa-19_slovakia-beer">Hellstork Kraken IPA 19°</a></li>
														<li><a href="kaltenecker-chopper-ipa-grand-champion-2012_slovakia-beer">Kaltenecker Chopper IPA Grand Champion 2012</a></li>
														<li><a href="sessler-tmavy-special-21_slovakia-beer">Sessler Tmavý Špeciál 21°</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Liquor (2)" class="item_link">Liquor (2)</a>
						<ul class="submenu">
														<li><a href="spisska-borovicka_slovakia-liquor">Spišská borovicka</a></li>
														<li><a href="tatratea-original_slovakia-liquor">Tatratea Original</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Slovakia.png" /><br>
Capital: <b>Bratislava</b><br>
Population: <b>5,421,034</b><br>
<div id="country_details">
Surface: <b>49,037 km²</b><br>
Currency: <b>EUR</b><br>
Motto: <b>No official motto</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Borovicka, Tatratea</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=slovakia" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Slovakia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="hellstork-kraken-ipa-19_slovakia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/hellstork-kraken-ipa-19_204.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/kaltenecker-chopper-ipa-grand-champion-2012_204.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/sessler-tmavy-special-21_204.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/spisska-borovicka_800.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Spišská borovicka</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="tatratea-original_slovakia-liquor">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/tatratea-original_800.jpeg" alt="" class="imagequery popular">
