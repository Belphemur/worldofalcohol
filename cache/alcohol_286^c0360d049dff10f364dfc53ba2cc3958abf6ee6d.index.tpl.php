...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca1ca412f6c3_70139378',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca1ca412f6c3_70139378')) {function content_54ca1ca412f6c3_70139378($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Ginjinha - Liquor NA from Alcobaça, Portugal</title>
        <meta name="description" content="Discover and share more Beer, Liquor, Port Wine from Portugal">
		<meta name="keywords" content="Ginjinha, Ginjinha Alcobaça, Portugal Liquor, Portugal NA Liquor, Ginjinha 20 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Ginjinha Liquor from Alcobaça, Portugal - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/ginjinha_799.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer, Liquor, Port Wine from Portugal"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/ginjinha_portugal-liquor"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Ginjinha</b></a></li>
	</ul>
	</nav>
</header>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Genre: NA<br>
		Brewery: Alcobaça<br>
		Brewed in: Alcobaça, Portugal<br><br>
		ABV: <b>20</b> %
		</div>
		<br>
 ...
 Ratings)</span>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="286" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="286" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="286" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="286" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="286" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
