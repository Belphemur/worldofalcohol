...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca1c3d2c5ee3_75654415',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca1c3d2c5ee3_75654415')) {function content_54ca1c3d2c5ee3_75654415($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Algeria Alcohols: Discover the best alcohols (None) from Algeria</title>
        <meta name="description" content="Discover and share local Beer, Wine from Algeria">
		<meta name="keywords" content="Algeria alcohols, alcohol Algeria, Beer Algeria, Wine Algeria, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Algeria Alcohols: Discover best None from Algeria - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Algeria.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Wine from Algeria"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/algeria-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Algeria</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="schems-bavaroise_algeria-beer">Schems Bavaroise</a></li>
														<li><a href="algad-golden-pils_algeria-beer">Algad Golden Pils</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Wine (1)" class="item_link">Wine (1)</a>
						<ul class="submenu">
														<li><a href="domaine-mamounia-coteaux-de-mascara_algeria-wine">Domaine Mamounia Coteaux de Mascara</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Algeria.png" /><br>
Capital: <b>Algiers</b><br>
Population: <b>39,500,000</b><br>
<div id="country_details">
Surface: <b>2,381,741 km²</b><br>
Currency: <b>DZD</b><br>
Motto: <b>بالشعب و للشعب (Bil-shaʿb wa lil-shaʿb) (« Arabic, By the people and for the people »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>None</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=algeria" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Algeria </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="schems-bavaroise_algeria-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/schems-bavaroise_784.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/domaine-mamounia-coteaux-de-mascara_784.jpeg" alt="" class="imagequery popular">
