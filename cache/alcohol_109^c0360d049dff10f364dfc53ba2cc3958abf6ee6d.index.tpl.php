...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c911a15a78e2_76245221',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c911a15a78e2_76245221')) {function content_54c911a15a78e2_76245221($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Kappa - Pisco NA from Elqui Valley, Chile</title>
        <meta name="description" content="Discover and share more Beer, Pisco from Chile">
		<meta name="keywords" content="Kappa, Kappa Marnier Lapostolle Family, Chile Pisco, Chile NA Pisco, Kappa 42.5 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/chile-alcohols">Chile</a></li>
	
	<li class="active"><a href="#"><b>Kappa</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-20 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/kappa_789.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Kappa</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Pisco<br>
		Genre: NA<br>
		Brewery: Marnier Lapostolle Family<br>
		Brewed in: Elqui Valley, Chile<br><br>
		ABV: <b>42.5</b> %
	...
	<div class="xlarge-30 large-30 medium-50 small-100"> 
		<form class="ink-form">
			<fieldset>
				<legend>Rate this Pisco</legend>
				<div id="my-progress-bar" class="ink-progress-bar grey" data-req-id="a16fc48bba53001e1caadc54de30639f" data-start-value="2">
				  <span class="caption">2 (1 Ratings)</span>
				  					<div class="bar orange"></div>
				  				</div>
				<div class="control-group">
					<p class="label">Have you tried this Pisco already? Let us know your opinion</p>
					<div id="rating_options">
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="109" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="109" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="109" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="109" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="109" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Chile ? Feel free to share it with us </h5>
		<a href="submit.php?country=chile" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Chile </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="szot-strong-ale-12_chile-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/szot-strong-ale-12_789.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Szot Strong Ale 12%</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="kross-5_chile-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/kross-5_789.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Kross 5</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="quimera-imperial-stout_chile-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/quimera-imperial-stout_789.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Quimera Imperial Stout</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="capel-35_chile-pisco">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/capel-35_790.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Capel 35</figcaption>
		</figure></a>                        
		</div>
	</div>
