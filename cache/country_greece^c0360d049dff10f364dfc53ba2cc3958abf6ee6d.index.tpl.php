...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca2229712ea2_79474087',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca2229712ea2_79474087')) {function content_54ca2229712ea2_79474087($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Greece Alcohols: Discover the best alcohols (Ouzo) from Greece</title>
        <meta name="description" content="Discover and share local Beer, Brandy, Ouzo from Greece">
		<meta name="keywords" content="Greece alcohols, alcohol Greece, Beer Greece, Brandy Greece, Ouzo Greece, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Greece Alcohols: Discover best Ouzo from Greece - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Greece.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Brandy, Ouzo from Greece"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/greece-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Greece</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="septem-ace_greece-beer">Septem A.C.E.</a></li>
														<li><a href="santorini-crazy-donkey_greece-beer">Santorini Crazy Donkey</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Brandy (1)" class="item_link">Brandy (1)</a>
						<ul class="submenu">
														<li><a href="metaxa-5-stars_greece-brandy">Metaxa 5 stars</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Ouzo (1)" class="item_link">Ouzo (1)</a>
						<ul class="submenu">
														<li><a href="plomari_greece-ouzo">Plomari</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Greece.png" /><br>
Capital: <b>Athens</b><br>
Population: <b>10,992,589</b><br>
<div id="country_details">
Surface: <b>131,990 km²</b><br>
Currency: <b>EUR</b><br>
Motto: <b>Ελευθερία ή θάνατος (Eleftheria i thanatos) (Greek, « Freedom or Death »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Ouzo</b><br>
</div>
</div>
	</div>
</div>
<div class="ink-alert basic warning all-60 small-100">
<h5>Do you know any other local alcohol from Greece ? Feel free to share it with us </h5>
<a href="submit.php?country=greece" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Greece </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="septem-ace_greece-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/septem-ace_115.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Septem A.C.E.</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="santorini-crazy-donkey_greece-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/santorini-crazy-donkey_116.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Santorini Crazy Donkey</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="metaxa-5-stars_greece-brandy">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/metaxa-5-stars_453.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Metaxa 5 stars</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="plomari_greece-ouzo">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/plomari_794.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Plomari</figcaption>
		</figure></a>                        
		</div>
	</div>
