...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9ed18eba7e8_19347966',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9ed18eba7e8_19347966')) {function content_54c9ed18eba7e8_19347966($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>China Alcohols: Discover the best alcohols (Moutai) from China</title>
        <meta name="description" content="Discover and share local Beer, Moutai from China">
		<meta name="keywords" content="China alcohols, alcohol China, Beer China, Moutai China, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="China Alcohols: Discover best Moutai from China - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/China.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Moutai from China"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/china-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>China</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="king-louie-imperial-stout_china-beer">King Louie Imperial Stout</a></li>
														<li><a href="hop-god-120-imperial-ipa_china-beer">Hop God 120 Imperial IPA</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Moutai (1)" class="item_link">Moutai (1)</a>
						<ul class="submenu">
														<li><a href="kweichow_china-moutai">Kweichow</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/China.png" /><br>
Capital: <b>Beijing</b><br>
Population: <b>1,367,740,000</b><br>
<div id="country_details">
Surface: <b>9,572,900 km²</b><br>
Currency: <b>CNY</b><br>
Motto: <b>No official motto</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Moutai</b><br>
</div>
</div>
	</div>
</div>
<div class="ink-alert basic warning all-60 small-100">
<h5>Do you know any other local alcohol from China ? Feel free to share it with us </h5>
<a href="submit.php?country=china" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from China </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="king-louie-imperial-stout_china-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/king-louie-imperial-stout_790.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">King Louie Imperial Stout</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="hop-god-120-imperial-ipa_china-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/hop-god-120-imperial-ipa_790.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Hop God 120 Imperial IPA</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="kweichow_china-moutai">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/kweichow_790.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Kweichow</figcaption>
		</figure></a>                        
		</div>
	</div>
