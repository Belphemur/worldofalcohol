...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9576291ab11_16720168',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9576291ab11_16720168')) {function content_54c9576291ab11_16720168($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Austria Alcohols: Discover the best alcohols (Schnapps) from Austria</title>
        <meta name="description" content="Discover and share local Beer, Liquor, Rum, Schnapps from Austria">
		<meta name="keywords" content="Austria alcohols, alcohol Austria, Beer Austria, Liquor Austria, Rum Austria, Schnapps Austria, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Austria Alcohols: Discover best Schnapps from Austria - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Austria.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Liquor, Rum, Schnapps from Austria"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/austria-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Austria</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="bevog-ond-smoked-porter_austria-beer">Bevog Ond Smoked Porter</a></li>
														<li><a href="1516-nz-victory-hop-devil-india-pale-ale_austria-beer">1516 NZ Victory Hop Devil India Pale Ale</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Liquor (1)" class="item_link">Liquor (1)</a>
						<ul class="submenu">
														<li><a href="mozart-black_austria-liquor">Mozart Black</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Rum (1)" class="item_link">Rum (1)</a>
						<ul class="submenu">
														<li><a href="stroh-60_austria-rum">Stroh 60°</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Schnapps (1)" class="item_link">Schnapps (1)</a>
						<ul class="submenu">
														<li><a href="bailoni-wachauer-apricot-schnapps_austria-schnapps">Bailoni Wachauer Apricot Schnapps</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Austria.png" /><br>
Capital: <b>Vienna</b><br>
Population: <b>8,572,895</b><br>
<div id="country_details">
Surface: <b>83,871 km²</b><br>
Currency: <b>EUR</b><br>
Motto: <b>Austriae est imperare orbi universo (Latin, « It is Austria's destiny to rule the world »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Schnapps</b><br>
</div>
</div>
...
<a href="submit.php?country=austria" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Austria </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="bevog-ond-smoked-porter_austria-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/bevog-ond-smoked-porter_785.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/mozart-black_529.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/stroh-60_505.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/NA.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/bailoni-wachauer-apricot-schnapps_785.jpeg" alt="" class="imagequery popular">
