...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c811668dc761_87664502',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c811668dc761_87664502')) {function content_54c811668dc761_87664502($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Afghanistan Alcohols: Discover the best alcohols (None) from Afghanistan</title>
        <meta name="description" content="Discover and share local  from Afghanistan">
		<meta name="keywords" content="Afghanistan alcohols, alcohol Afghanistan,  Afghanistan, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Afghanistan</b></a></li>
	</ul>
	</nav>
</header>
...
<img src="flags_mini/Afghanistan.png" /><br>
Capital: <b>Kabul</b><br>
Population: <b>26,556,800</b><br>
<div id="country_details">
Surface: <b>652,230 km²</b><br>
Currency: <b>AFN</b><br>
Motto: <b>No official motto</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>None</b><br>
	Other Infos: <b>Forbidden, except for tourists</b>
</div>
</div>
...
<h5>Do you know any other local alcohol from Afghanistan ? Feel free to share it with us </h5>
<a href="submit.php?country=afghanistan" class="ink-button green"> Submit local alcohol </a><br>
</div>
