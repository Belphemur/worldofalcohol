...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c997c5a9d1b5_77584887',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c997c5a9d1b5_77584887')) {function content_54c997c5a9d1b5_77584887($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Al-Amoudi Rich Regular - Beer Low Alcohol from Jeddah, Saudi Arabia</title>
        <meta name="description" content="Discover and share more Beer from Saudi Arabia">
		<meta name="keywords" content="Al-Amoudi Rich Regular, Al-Amoudi Rich Regular Al-Amoudi Beverage Industries, Saudi Arabia Beer, Saudi Arabia Low Alcohol Beer, Al-Amoudi Rich Regular 0.5 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Al-Amoudi Rich Regular Beer from Jeddah, Saudi Arabia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/al-amoudi-rich-regular_199.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer from Saudi Arabia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/al-amoudi-rich-regular_saudi-arabia-beer"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/saudi-arabia-alcohols">Saudi Arabia</a></li>
	
	<li class="active"><a href="#"><b>Al-Amoudi Rich Regular</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/al-amoudi-rich-regular_199.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Al-Amoudi Rich Regular</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Beer<br>
		Genre: Low Alcohol<br>
		Brewery: Al-Amoudi Beverage Industries<br>
		Brewed in: Jeddah, Saudi Arabia<br><br>
		ABV: <b>0.5</b> %
		</div>
		<br>
 ...
 Ratings)</span>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="472" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="472" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="472" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="472" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="472" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Saudi Arabia ? Feel free to share it with us </h5>
		<a href="submit.php?country=saudi-arabia" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Saudi Arabia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="bario-classic_saudi-arabia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/bario-classic_200.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Bario Classic</figcaption>
		</figure></a>                        
		</div>
	</div>
