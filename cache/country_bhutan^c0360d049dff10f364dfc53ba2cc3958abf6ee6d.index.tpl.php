...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c8ed64bb5180_74111467',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c8ed64bb5180_74111467')) {function content_54c8ed64bb5180_74111467($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Bhutan Alcohols: Discover the best alcohols (Arra) from Bhutan</title>
        <meta name="description" content="Discover and share local Beer from Bhutan">
		<meta name="keywords" content="Bhutan alcohols, alcohol Bhutan, Beer Bhutan, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Bhutan</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="red-panda-weissbier_bhutan-beer">Red Panda Weissbier</a></li>
														<li><a href="druk-11000-strong_bhutan-beer">Druk 11000 Strong</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Bhutan.png" /><br>
Capital: <b>Thimphu</b><br>
Population: <b>756,320</b><br>
<div id="country_details">
Surface: <b>38,394 km²</b><br>
Currency: <b>BTN</b><br>
Motto: <b>No official motto</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Arra</b><br>
</div>
</div>
...
<h5>Do you know any other local alcohol from Bhutan ? Feel free to share it with us </h5>
<a href="submit.php?country=bhutan" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Bhutan </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="red-panda-weissbier_bhutan-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/red-panda-weissbier_786.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Red Panda Weissbier</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="druk-11000-strong_bhutan-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/druk-11000-strong_787.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Druk 11000 Strong</figcaption>
		</figure></a>                        
		</div>
	</div>
