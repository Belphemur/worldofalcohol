...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9fb98e4fb65_76815960',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9fb98e4fb65_76815960')) {function content_54c9fb98e4fb65_76815960($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Albania Alcohols: Discover the best alcohols (Raki) from Albania</title>
        <meta name="description" content="Discover and share local Beer, Cognac, Wine from Albania">
		<meta name="keywords" content="Albania alcohols, alcohol Albania, Beer Albania, Cognac Albania, Wine Albania, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Albania Alcohols: Discover best Raki from Albania - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Albania.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Cognac, Wine from Albania"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/albania-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Albania</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="tirana_albania-beer">Tirana</a></li>
														<li><a href="dark-ale_albania-beer">Dark Ale</a></li>
														<li><a href="puka_albania-beer">Puka</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Cognac (1)" class="item_link">Cognac (1)</a>
						<ul class="submenu">
														<li><a href="skenderbeu_albania-cognac">Skenderbeu</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Wine (1)" class="item_link">Wine (1)</a>
						<ul class="submenu">
														<li><a href="shesh-i-bardhe_albania-wine">Shesh i Bardhë</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Albania.png" /><br>
Capital: <b>Tirana</b><br>
Population: <b>2,895,947</b><br>
<div id="country_details">
Surface: <b>28,748 km²</b><br>
Currency: <b>ALL</b><br>
Motto: <b>Ti Shqiperi Me Jep Nder, Me jep Emrin Shqipetar (Albanian, « You, Albania, give me honor, give me the name Albanian »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Raki</b><br>
</div>
</div>
	</div>
</div>
<div class="ink-alert basic warning all-60 small-100">
<h5>Do you know any other local alcohol from Albania ? Feel free to share it with us </h5>
<a href="submit.php?country=albania" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Albania </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="tirana_albania-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/tirana_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Tirana</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="dark-ale_albania-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/dark-ale_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Dark Ale</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="puka_albania-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/puka_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Puka</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="skenderbeu_albania-cognac">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/skenderbeu_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Skenderbeu</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="shesh-i-bardhe_albania-wine">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/shesh-i-bardhe_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Shesh i Bardhë</figcaption>
		</figure></a>                        
		</div>
	</div>
