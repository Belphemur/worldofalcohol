...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9ec901cb637_81259973',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9ec901cb637_81259973')) {function content_54c9ec901cb637_81259973($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Croatia Alcohols: Discover the best alcohols (Rakija) from Croatia</title>
        <meta name="description" content="Discover and share local Beer, Rakia from Croatia">
		<meta name="keywords" content="Croatia alcohols, alcohol Croatia, Beer Croatia, Rakia Croatia, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Croatia Alcohols: Discover best Rakija from Croatia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Croatia.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Rakia from Croatia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/croatia-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Croatia</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="zmajska-pivovara-porter_croatia-beer">Zmajska Pivovara Porter</a></li>
														<li><a href="pivnica-medvedgrad-fakin-ipa_croatia-beer">Pivnica Medvedgrad Fakin IPA</a></li>
														<li><a href="tomislav-tamno-pivo_croatia-beer">Tomislav Tamno Pivo</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Rakia (2)" class="item_link">Rakia (2)</a>
						<ul class="submenu">
														<li><a href="travarica_croatia-rakia">Travarica</a></li>
														<li><a href="medica_croatia-rakia">Medica</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Croatia.png" /><br>
Capital: <b>Zagreb</b><br>
Population: <b>4,267,558</b><br>
<div id="country_details">
Surface: <b>56,594 km²</b><br>
Currency: <b>HRK</b><br>
Motto: <b>No official motto</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Rakija</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=croatia" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Croatia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="zmajska-pivovara-porter_croatia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/zmajska-pivovara-porter_790.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/tomislav-tamno-pivo_790.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/pivnica-medvedgrad-fakin-ipa_790.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/travarica_790.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/medica_791.jpeg" alt="" class="imagequery popular">
