...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c903bdbeae60_00184048',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c903bdbeae60_00184048')) {function content_54c903bdbeae60_00184048($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Bailoni Wachauer Apricot Schnapps - Schnapps Apricot Schnapps from Krems an der Donau, Austria</title>
        <meta name="description" content="Discover and share more Beer, Liquor, Rum, Schnapps from Austria">
		<meta name="keywords" content="Bailoni Wachauer Apricot Schnapps, Bailoni Wachauer Apricot Schnapps Bailoni, Austria Schnapps, Austria Apricot Schnapps Schnapps, Bailoni Wachauer Apricot Schnapps 40 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/austria-alcohols">Austria</a></li>
	
	<li class="active"><a href="#"><b>Bailoni Wachauer Apricot Schnapps</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-20 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/bailoni-wachauer-apricot-schnapps_785.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Bailoni Wachauer Apricot Schnapps</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Schnapps<br>
		Genre: Apricot Schnapps<br>
		Brewery: Bailoni<br>
		Brewed in: Krems an der Donau, Austria<br><br>
		ABV: <b>40</b> %
	...
	<div class="xlarge-30 large-30 medium-50 small-100"> 
		<form class="ink-form">
			<fieldset>
				<legend>Rate this Schnapps</legend>
				<div id="my-progress-bar" class="ink-progress-bar grey" data-req-id="d057f7c031d016ab2cf09dc227b6a320" data-start-value="">
				  <span class="caption"> (0 Ratings)</span>
				  					<div class="bar red"></div>
				  				</div>
				<div class="control-group">
					<p class="label">Have you tried this Schnapps already? Let us know your opinion</p>
					<div id="rating_options">
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="29" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="29" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="29" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="29" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="29" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Austria ? Feel free to share it with us </h5>
		<a href="submit.php?country=austria" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Austria </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="mozart-black_austria-liquor">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/mozart-black_529.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Mozart Black</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="stroh-60_austria-rum">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/stroh-60_505.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Stroh 60°</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="bevog-ond-smoked-porter_austria-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/bevog-ond-smoked-porter_785.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Bevog Ond Smoked Porter</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="1516-nz-victory-hop-devil-india-pale-ale_austria-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/NA.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">1516 NZ Victory Hop Devil India Pale Ale</figcaption>
		</figure></a>                        
		</div>
	</div>
