...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca2030bd6413_30604919',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca2030bd6413_30604919')) {function content_54ca2030bd6413_30604919($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Norway Alcohols: Discover the best alcohols (Akevitt) from Norway</title>
        <meta name="description" content="Discover and share local Akvavit, Beer from Norway">
		<meta name="keywords" content="Norway alcohols, alcohol Norway, Akvavit Norway, Beer Norway, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Norway Alcohols: Discover best Akevitt from Norway - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Norway.png"/>
		 
		<meta property="og:description" content="Discover and share local Akvavit, Beer from Norway"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/norway-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Norway</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
									<li class="menu_id">
						<a href="#Akvavit (2)" class="item_link">Akvavit (2)</a>
						<ul class="submenu">
														<li><a href="gilde-non-plus-ultra-aquavit_norway-akvavit">Gilde Non Plus Ultra Aquavit</a></li>
														<li><a href="loitens-sommer-aquavit_norway-akvavit">Løitens Sommer Aquavit</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Beer (2)" class="item_link">Beer (2)</a>
						<ul class="submenu">
														<li><a href="nogne-o-imperial-stout_norway-beer">Nøgne Ø Imperial Stout</a></li>
														<li><a href="aegir-lynchburg-natt_norway-beer">Ægir Lynchburg Natt</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Norway.png" /><br>
Capital: <b>Oslo</b><br>
Population: <b>5,156,450</b><br>
<div id="country_details">
Surface: <b>323,802 km²</b><br>
Currency: <b>NOK</b><br>
Motto: <b>Royal motto: Alt for Norge (Norwegian, « Everything for Norway ») and Eidsvoll oath: Enige og troe, indtil Dovre falder (Norwegian, « United and loyal until the mountains of Dovre crumble »)</b><br><br>
Drinking age: <b>Less than 22% abv:18; more than 22% abv:20</b><br>
National Alcohols: <b>Akevitt</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=norway" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Norway </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="gilde-non-plus-ultra-aquavit_norway-akvavit">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/gilde-non-plus-ultra-aquavit_797.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/loitens-sommer-aquavit_797.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/nogne-o-imperial-stout_196.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/aegir-lynchburg-natt_196.jpeg" alt="" class="imagequery popular">
