...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c811d5e334f0_24664497',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c811d5e334f0_24664497')) {function content_54c811d5e334f0_24664497($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Falkland Islands Alcohols: Discover the best alcohols () from Falkland Islands</title>
        <meta name="description" content="Discover and share local Beer from Falkland Islands">
		<meta name="keywords" content="Falkland Islands alcohols, alcohol Falkland Islands, Beer Falkland Islands, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Falkland Islands</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="falkland-beerworks-maiden-bitter_falkland-islands-beer">Falkland Beerworks Maiden Bitter</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<h5>Do you know any other local alcohol from Falkland Islands ? Feel free to share it with us </h5>
<a href="submit.php?country=falkland-islands" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Falkland Islands </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="falkland-beerworks-maiden-bitter_falkland-islands-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/falkland-beerworks-maiden-bitter_793.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Falkland Beerworks Maiden Bitter</figcaption>
		</figure></a>                        
		</div>
	</div>
