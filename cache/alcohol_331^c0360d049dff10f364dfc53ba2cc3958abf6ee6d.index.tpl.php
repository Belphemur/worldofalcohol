...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c965ef7b7cc0_60189200',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c965ef7b7cc0_60189200')) {function content_54c965ef7b7cc0_60189200($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Greenland Easter Bock - Beer Weizen Bock from Narsaq, Greenland</title>
        <meta name="description" content="Discover and share more Beer from Greenland">
		<meta name="keywords" content="Greenland Easter Bock, Greenland Easter Bock Greenland Brewhouse, Greenland Beer, Greenland Weizen Bock Beer, Greenland Easter Bock 7.5 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Greenland Easter Bock Beer from Narsaq, Greenland - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/greenland-easter-bock_118.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer from Greenland"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/greenland-easter-bock_greenland-beer"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/greenland-alcohols">Greenland</a></li>
	
	<li class="active"><a href="#"><b>Greenland Easter Bock</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/greenland-easter-bock_118.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Greenland Easter Bock</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Beer<br>
		Genre: Weizen Bock<br>
		Brewery: Greenland Brewhouse<br>
		Brewed in: Narsaq, Greenland<br><br>
		ABV: <b>7.5</b> %
		</div>
		<br>
 ...
 Ratings)</span>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="331" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="331" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="331" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="331" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="331" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Greenland ? Feel free to share it with us </h5>
		<a href="submit.php?country=greenland" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>
