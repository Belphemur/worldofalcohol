...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9ba08525f68_98666893',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9ba08525f68_98666893')) {function content_54c9ba08525f68_98666893($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Witch’s Rock Pale Ale - Beer Pale Ale from Tamarindo, Costa Rica</title>
        <meta name="description" content="Discover and share more Beer, Guaro from Costa Rica">
		<meta name="keywords" content="Witch’s Rock Pale Ale, Witch’s Rock Pale Ale Tamarindo Brewing Company, Costa Rica Beer, Costa Rica Pale Ale Beer, Witch’s Rock Pale Ale 0 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Witch’s Rock Pale Ale Beer from Tamarindo, Costa Rica - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/witch-s-rock-pale-ale_790.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer, Guaro from Costa Rica"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/witch-s-rock-pale-ale_costa-rica-beer"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/costa-rica-alcohols">Costa Rica</a></li>
	
	<li class="active"><a href="#"><b>Witch’s Rock Pale Ale</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/witch-s-rock-pale-ale_790.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Witch’s Rock Pale Ale</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Beer<br>
		Genre: Pale Ale<br>
		Brewery: Tamarindo Brewing Company<br>
		Brewed in: Tamarindo, Costa Rica<br><br>
		ABV: <b>0</b> %
		</div>
		<br>
 ...
 Ratings)</span>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="123" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="123" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="123" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="123" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="123" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Costa Rica ? Feel free to share it with us </h5>
		<a href="submit.php?country=costa-rica" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Costa Rica </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="segua-red-ale_costa-rica-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/segua-red-ale_790.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Segua Red Ale</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="tumba-calzones_costa-rica-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/tumba-calzones_790.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Tumba Calzones</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="cacique-guaro_costa-rica-guaro">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/cacique-guaro_790.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Cacique Guaro</figcaption>
		</figure></a>                        
		</div>
	</div>
