...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c81a77c8d317_31788757',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c81a77c8d317_31788757')) {function content_54c81a77c8d317_31788757($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Netherlands Alcohols: Discover the best alcohols (Jenever) from Netherlands</title>
        <meta name="description" content="Discover and share local Beer, Jenever, Liquor from Netherlands">
		<meta name="keywords" content="Netherlands alcohols, alcohol Netherlands, Beer Netherlands, Jenever Netherlands, Liquor Netherlands, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Netherlands</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="de-molen-hel-verdoemenis-666_netherlands-beer">De Molen Hel & Verdoemenis 666</a></li>
														<li><a href="emelisse-white-label-imperial-russian-stout-wild-turkey-ba_netherlands-beer">Emelisse White Label Imperial Russian Stout (Wild Turkey BA)</a></li>
														<li><a href="heineken_netherlands-beer">Heineken</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Jenever (1)" class="item_link">Jenever (1)</a>
						<ul class="submenu">
														<li><a href="bokma-citroen-jenever_netherlands-jenever">Bokma Citroen Jenever</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Liquor (1)" class="item_link">Liquor (1)</a>
						<ul class="submenu">
														<li><a href="pisang-ambon-the-original_netherlands-liquor">Pisang Ambon The Original</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Netherlands.png" /><br>
Capital: <b>Amsterdam</b><br>
Population: <b>16,886,100</b><br>
<div id="country_details">
Surface: <b>41,850 km²</b><br>
Currency: <b>EUR</b><br>
Motto: <b>Je maintiendrai; Ik zal handhaven (French, Dutch: « I will maintain »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Jenever</b><br>
</div>
</div>
...
<h5>Do you know any other local alcohol from Netherlands ? Feel free to share it with us </h5>
<a href="submit.php?country=netherlands" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Netherlands </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="heineken_netherlands-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/heineken_420.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Heineken</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="de-molen-hel-verdoemenis-666_netherlands-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/de-molen-hel-verdoemenis-666_196.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">De Molen Hel & Verdoemenis 666</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="emelisse-white-label-imperial-russian-stout-wild-turkey-ba_netherlands-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/emelisse-white-label-imperial-russian-stout-wild-turkey-ba_196.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Emelisse White Label Imperial Russian Stout (Wild Turkey BA)</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="bokma-citroen-jenever_netherlands-jenever">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/bokma-citroen-jenever_797.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Bokma Citroen Jenever</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="pisang-ambon-the-original_netherlands-liquor">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/pisang-ambon-the-original_448.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Pisang Ambon The Original</figcaption>
		</figure></a>                        
		</div>
	</div>
