...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c920dfe4e6b2_09016444',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c920dfe4e6b2_09016444')) {function content_54c920dfe4e6b2_09016444($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Reunion Alcohols: Discover the best alcohols (Rhum Arrange) from Reunion</title>
        <meta name="description" content="Discover and share local Rum from Reunion">
		<meta name="keywords" content="Reunion alcohols, alcohol Reunion, Rum Reunion, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Reunion</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="lontan_reunion-rum">Lontan</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<h5>Do you know any other local alcohol from Reunion ? Feel free to share it with us </h5>
<a href="submit.php?country=reunion" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Reunion </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="lontan_reunion-rum">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/lontan_799.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Lontan</figcaption>
		</figure></a>                        
		</div>
	</div>
