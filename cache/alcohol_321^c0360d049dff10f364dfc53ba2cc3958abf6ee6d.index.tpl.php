...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c8ddb4468517_84090456',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c8ddb4468517_84090456')) {function content_54c8ddb4468517_84090456($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Alpha Sant Cornelli - Beer Indian Pale Ale from La Cortinada Ordino, Andorra</title>
        <meta name="description" content="Discover and share more Beer, Wine from Andorra">
		<meta name="keywords" content="Alpha Sant Cornelli, Alpha Sant Cornelli Cerveses Alpha, Andorra Beer, Andorra Indian Pale Ale Beer, Alpha Sant Cornelli 6.4 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/andorra-alcohols">Andorra</a></li>
	
	<li class="active"><a href="#"><b>Alpha Sant Cornelli</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-20 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/alpha-sant-cornelli_110.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Alpha Sant Cornelli</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Brewery: Cerveses Alpha<br>
		Brewed in: La Cortinada Ordino, Andorra<br><br>
		ABV: <b>6.4</b> %
	...
	<div class="xlarge-30 large-30 medium-50 small-100"> 
			...
			<fieldset>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="321" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="321" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="321" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="321" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="321" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Andorra ? Feel free to share it with us </h5>
		<a href="submit.php?country=andorra" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Andorra </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="escarxat-ermita-a-la-mora_andorra-wine">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/escarxat-ermita-a-la-mora_784.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Escarxat Ermita a la Mora</figcaption>
		</figure></a>                        
		</div>
	</div>
