...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c957b3e6f063_74407918',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c957b3e6f063_74407918')) {function content_54c957b3e6f063_74407918($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Chile Alcohols: Discover the best alcohols (Wine, Pisco) from Chile</title>
        <meta name="description" content="Discover and share local Beer, Pisco from Chile">
		<meta name="keywords" content="Chile alcohols, alcohol Chile, Beer Chile, Pisco Chile, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Chile Alcohols: Discover best Wine, Pisco from Chile - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Chile.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Pisco from Chile"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/chile-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Chile</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="szot-strong-ale-12_chile-beer">Szot Strong Ale 12%</a></li>
														<li><a href="quimera-imperial-stout_chile-beer">Quimera Imperial Stout</a></li>
														<li><a href="kross-5_chile-beer">Kross 5</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Pisco (2)" class="item_link">Pisco (2)</a>
						<ul class="submenu">
														<li><a href="kappa_chile-pisco">Kappa</a></li>
														<li><a href="capel-35_chile-pisco">Capel 35</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Chile.png" /><br>
Capital: <b>Valparaíso (legislative), Santiago (official)</b><br>
Population: <b>18,006,407</b><br>
<div id="country_details">
Surface: <b>756,102 km²</b><br>
Currency: <b>CLP</b><br>
Motto: <b>Por la razón o la fuerza (Spanish, « Through Reason Or By Force »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Wine, Pisco</b><br>
</div>
</div>
...
<a href="submit.php?country=chile" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Chile </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="kappa_chile-pisco">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/kappa_789.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/szot-strong-ale-12_789.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/kross-5_789.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/quimera-imperial-stout_789.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/capel-35_790.jpeg" alt="" class="imagequery popular">
