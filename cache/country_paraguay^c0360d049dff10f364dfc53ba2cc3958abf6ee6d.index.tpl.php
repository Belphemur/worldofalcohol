...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca1c6d6977c2_34785465',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca1c6d6977c2_34785465')) {function content_54ca1c6d6977c2_34785465($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Paraguay Alcohols: Discover the best alcohols (CaÑa) from Paraguay</title>
        <meta name="description" content="Discover and share local Beer, Rum from Paraguay">
		<meta name="keywords" content="Paraguay alcohols, alcohol Paraguay, Beer Paraguay, Rum Paraguay, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Paraguay Alcohols: Discover best CaÑa from Paraguay - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Paraguay.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Rum from Paraguay"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/paraguay-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Paraguay</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="sajonia-pale-ale_paraguay-beer">Sajonia Pale Ale</a></li>
														<li><a href="cerveceria-paraguayana-pilsen-cerveza-blanca_paraguay-beer">Cerveceria Paraguayana Pilsen Cerveza Blanca</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Rum (1)" class="item_link">Rum (1)</a>
						<ul class="submenu">
														<li><a href="papagayo-spiced-rum_paraguay-rum">Papagayo Spiced Rum</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Paraguay.png" /><br>
Capital: <b>Asunción</b><br>
Population: <b>6,893,727</b><br>
<div id="country_details">
Surface: <b>406,752 km²</b><br>
Currency: <b>PYG</b><br>
Motto: <b>Paz y justicia (Spanish, « Peace and justice »)</b><br><br>
Drinking age: <b>20</b><br>
National Alcohols: <b>CaÑa</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=paraguay" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Paraguay </h3>
<div class="column-group gutters"> 
		...
		<figcaption class="dark over-bottom">Sajonia Pale Ale</figcaption>
			...
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="cerveceria-paraguayana-pilsen-cerveza-blanca_paraguay-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/cerveceria-paraguayana-pilsen-cerveza-blanca_197.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/papagayo-spiced-rum_798.jpeg" alt="" class="imagequery popular">
