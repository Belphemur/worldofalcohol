...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c81b9e1d5951_24890891',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c81b9e1d5951_24890891')) {function content_54c81b9e1d5951_24890891($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Ethiopia Alcohols: Discover the best alcohols (Tej) from Ethiopia</title>
        <meta name="description" content="Discover and share local Beer, Tej from Ethiopia">
		<meta name="keywords" content="Ethiopia alcohols, alcohol Ethiopia, Beer Ethiopia, Tej Ethiopia, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Ethiopia</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="garden-brau-ebony_ethiopia-beer">Garden Bräu Ebony</a></li>
														<li><a href="bedele-beer_ethiopia-beer">Bedele Beer</a></li>
														<li><a href="hakim-stout_ethiopia-beer">Hakim Stout</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Tej (1)" class="item_link">Tej (1)</a>
						<ul class="submenu">
														<li><a href="pure-honey-tej_ethiopia-tej">Pure Honey Tej</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Ethiopia.png" /><br>
Capital: <b>Addis Ababa</b><br>
Population: <b>90,076,012</b><br>
<div id="country_details">
Surface: <b>1,104,300 km²</b><br>
Currency: <b>ETB</b><br>
Motto: <b>Formerly ኢትዮጵያ ታበድ አደዊሃ ሃበ አግዚአብሐር (Itiyopia tabetsih edewiha habe Igziabiher) (Ge'ez, « Ethiopia holds up her hands unto God »). Currently none.</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Tej</b><br>
</div>
</div>
...
<a href="submit.php?country=ethiopia" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Ethiopia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="hakim-stout_ethiopia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/hakim-stout_793.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/garden-brau-ebony_793.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/bedele-beer_793.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/pure-honey-tej_793.jpeg" alt="" class="imagequery popular">
