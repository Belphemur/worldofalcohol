...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9453fa93fa4_28968378',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9453fa93fa4_28968378')) {function content_54c9453fa93fa4_28968378($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Hong Kong Alcohols: Discover the best alcohols (None) from Hong Kong</title>
        <meta name="description" content="Discover and share local Beer from Hong Kong">
		<meta name="keywords" content="Hong Kong alcohols, alcohol Hong Kong, Beer Hong Kong, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Hong Kong Alcohols: Discover best None from Hong Kong - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Hong.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer from Hong Kong"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/hong-kong-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Hong Kong</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="young-master-1842-island-imperial-ipa_hong-kong-beer">Young Master 1842 Island Imperial IPA</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Hong.png" /><br>
Capital: <b>Hong Kong</b><br>
Population: <b>7,234,800</b><br>
<div id="country_details">
Surface: <b>1,104 km²</b><br>
Currency: <b>HKD</b><br>
Motto: <b>Dieu et mon droit (French, « God and my right »)</b><br><br>
...
<a href="submit.php?country=hong-kong" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Hong Kong </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="young-master-1842-island-imperial-ipa_hong-kong-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/young-master-1842-island-imperial-ipa_130.jpeg" alt="" class="imagequery popular">
