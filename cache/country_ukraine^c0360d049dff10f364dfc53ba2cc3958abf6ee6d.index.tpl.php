...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c95c8143ff02_09797830',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c95c8143ff02_09797830')) {function content_54c95c8143ff02_09797830($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Ukraine Alcohols: Discover the best alcohols (Horilka) from Ukraine</title>
        <meta name="description" content="Discover and share local Beer, Liquor from Ukraine">
		<meta name="keywords" content="Ukraine alcohols, alcohol Ukraine, Beer Ukraine, Liquor Ukraine, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Ukraine Alcohols: Discover best Horilka from Ukraine - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Ukraine.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Liquor from Ukraine"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/ukraine-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Ukraine</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="lvivske-porter_ukraine-beer">Lvivske Porter</a></li>
														<li><a href="obolon-porter_ukraine-beer">Obolon Porter</a></li>
														<li><a href="pshenychne-etalon_ukraine-beer">Pshenychne Etalon</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Liquor (1)" class="item_link">Liquor (1)</a>
						<ul class="submenu">
														<li><a href="horilka-honey-pepper_ukraine-liquor">Horilka Honey Pepper</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Ukraine.png" /><br>
Capital: <b>Kiev</b><br>
Population: <b>42,965,105</b><br>
<div id="country_details">
Surface: <b>603,500 km²</b><br>
Currency: <b>UAH</b><br>
Motto: <b>Слава Україні! (Slava Ukrayini) (Ukrainian, « Glory to Ukraine! »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Horilka</b><br>
</div>
</div>
...
<h5>Do you know any other local alcohol from Ukraine ? Feel free to share it with us </h5>
<a href="submit.php?country=ukraine" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Ukraine </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="lvivske-porter_ukraine-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/lvivske-porter_279.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Lvivske Porter</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="obolon-porter_ukraine-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/obolon-porter_280.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Obolon Porter</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="pshenychne-etalon_ukraine-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/pshenychne-etalon_281.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Pshenychne Etalon</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="horilka-honey-pepper_ukraine-liquor">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/horilka-honey-pepper_796.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Horilka Honey Pepper</figcaption>
		</figure></a>                        
		</div>
	</div>
