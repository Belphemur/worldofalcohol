...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c908b3919663_77764041',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c908b3919663_77764041')) {function content_54c908b3919663_77764041($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Morocco Alcohols: Discover the best alcohols (None) from Morocco</title>
        <meta name="description" content="Discover and share local Beer from Morocco">
		<meta name="keywords" content="Morocco alcohols, alcohol Morocco, Beer Morocco, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Morocco</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="casablanca-casa-beer_morocco-beer">Casablanca (Casa Beer)</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Morocco.png" /><br>
Capital: <b>Rabat</b><br>
Population: <b>33,499,800</b><br>
<div id="country_details">
Surface: <b>446,550 km²</b><br>
Currency: <b>MAD</b><br>
Motto: <b>الله، الوطن، الملك (Allāh, Al-Waṭan, Al-Malīk) (Arabic, « God, the Country, the King »)</b><br><br>
Drinking age: <b>16</b><br>
...
<a href="submit.php?country=morocco" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Morocco </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="casablanca-casa-beer_morocco-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/casablanca-casa-beer_190.jpeg" alt="" class="imagequery popular">
