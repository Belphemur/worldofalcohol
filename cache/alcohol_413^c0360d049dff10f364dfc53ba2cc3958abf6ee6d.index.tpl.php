...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca1aea866715_69326881',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca1aea866715_69326881')) {function content_54ca1aea866715_69326881($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Nikšicko Tamno - Beer Pale Lager from Nikšic, Montenegro</title>
        <meta name="description" content="Discover and share more Beer, Rakia from Montenegro">
		<meta name="keywords" content="Nikšicko Tamno, Nikšicko Tamno Trebjesa (MolsonCoors), Montenegro Beer, Montenegro Pale Lager Beer, Nikšicko Tamno 6.2 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Nikšicko Tamno Beer from Nikšic, Montenegro - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/niksicko-tamno_190.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer, Rakia from Montenegro"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/niksicko-tamno_montenegro-beer"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/montenegro-alcohols">Montenegro</a></li>
	
	<li class="active"><a href="#"><b>Nikšicko Tamno</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/niksicko-tamno_190.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Nikšicko Tamno</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Beer<br>
		Genre: Pale Lager<br>
		Brewery: Trebjesa (MolsonCoors)<br>
		Brewed in: Nikšic, Montenegro<br><br>
		ABV: <b>6.2</b> %
		</div>
		<br>
 ...
 Ratings)</span>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="413" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="413" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="413" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="413" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="413" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Montenegro ? Feel free to share it with us </h5>
		<a href="submit.php?country=montenegro" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Montenegro </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="sojak_montenegro-rakia">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/sojak_797.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Sojak</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="niksicko-gold_montenegro-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/niksicko-gold_190.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Nikšicko Gold</figcaption>
		</figure></a>                        
		</div>
	</div>
