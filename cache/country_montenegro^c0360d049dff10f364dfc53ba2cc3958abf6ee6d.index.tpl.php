...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c997ea074363_94453393',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c997ea074363_94453393')) {function content_54c997ea074363_94453393($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Montenegro Alcohols: Discover the best alcohols (Rakija) from Montenegro</title>
        <meta name="description" content="Discover and share local Beer, Rakia from Montenegro">
		<meta name="keywords" content="Montenegro alcohols, alcohol Montenegro, Beer Montenegro, Rakia Montenegro, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Montenegro Alcohols: Discover best Rakija from Montenegro - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Montenegro.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Rakia from Montenegro"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/montenegro-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Montenegro</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="niksicko-tamno_montenegro-beer">Nikšicko Tamno</a></li>
														<li><a href="niksicko-gold_montenegro-beer">Nikšicko Gold</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Rakia (1)" class="item_link">Rakia (1)</a>
						<ul class="submenu">
														<li><a href="sojak_montenegro-rakia">Sojak</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Montenegro.png" /><br>
Capital: <b>Cetinje (seat of the President), Podgorica (official)</b><br>
Population: <b>620,029</b><br>
<div id="country_details">
Surface: <b>13,812 km²</b><br>
Currency: <b>EUR</b><br>
...
<a href="submit.php?country=montenegro" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Montenegro </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="niksicko-tamno_montenegro-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/niksicko-tamno_190.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/niksicko-gold_190.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/sojak_797.jpeg" alt="" class="imagequery popular">
