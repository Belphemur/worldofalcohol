...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c94e3ca7f6d6_17660238',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c94e3ca7f6d6_17660238')) {function content_54c94e3ca7f6d6_17660238($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>French Polynesia Alcohols: Discover the best alcohols (None) from French Polynesia</title>
        <meta name="description" content="Discover and share local Beer from French Polynesia">
		<meta name="keywords" content="French Polynesia alcohols, alcohol French Polynesia, Beer French Polynesia, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="French Polynesia Alcohols: Discover best None from French Polynesia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/France.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer from French Polynesia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/french-polynesia-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>French Polynesia</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="hinano-ambree_french-polynesia-beer">Hinano Ambrée</a></li>
														<li><a href="tabu_french-polynesia-beer">Tabu</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
Capital: <b>Papeete</b><br>
Population: <b>268,270</b><br>
<div id="country_details">
Surface: <b>4,167 km²</b><br>
Currency: <b>XPF</b><br>
Motto: <b>Tahiti Nui Māre'are'a (Tahitian, « Great Tahiti of the Golden Haze »)</b><br><br>
...
<a href="submit.php?country=french-polynesia" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from French Polynesia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="hinano-ambree_french-polynesia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/hinano-ambree_794.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/tabu_794.jpeg" alt="" class="imagequery popular">
