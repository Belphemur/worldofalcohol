...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9742472d7c5_97409965',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9742472d7c5_97409965')) {function content_54c9742472d7c5_97409965($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Brazil Alcohols: Discover the best alcohols (CachaÇa) from Brazil</title>
        <meta name="description" content="Discover and share local Beer, Cachaça from Brazil">
		<meta name="keywords" content="Brazil alcohols, alcohol Brazil, Beer Brazil, Cachaça Brazil, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Brazil Alcohols: Discover best CachaÇa from Brazil - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Brazil.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Cachaça from Brazil"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/brazil-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Brazil</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="invicta-1000-ibu_brazil-beer">Invicta 1000 IBU</a></li>
														<li><a href="colorado-vintage-black-rapadura_brazil-beer">Colorado Vintage Black Rapadura</a></li>
														<li><a href="bodebrown-perigosa-imperial-ipa_brazil-beer">Bodebrown Perigosa Imperial IPA</a></li>
														<li><a href="wals-petroleum_brazil-beer">Wäls Petroleum</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Cachaça (2)" class="item_link">Cachaça (2)</a>
						<ul class="submenu">
														<li><a href="barrel-aged-cachaca_brazil-cachaca">Barrel-Aged Cachaça</a></li>
														<li><a href="pitu-aguardente-de-cana_brazil-cachaca">Pitú Aguardente de cana</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Brazil.png" /><br>
Capital: <b>Brasília</b><br>
Population: <b>203,759,000</b><br>
<div id="country_details">
Surface: <b>8,515,767 km²</b><br>
Currency: <b>BRL</b><br>
Motto: <b>Ordem e progresso (Portuguese, « Order and progress »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>CachaÇa</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=brazil" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Brazil </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="pitu-aguardente-de-cana_brazil-cachaca">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/pitu-aguardente-de-cana_533.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/bodebrown-perigosa-imperial-ipa_787.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/wals-petroleum_787.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/barrel-aged-cachaca_787.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/invicta-1000-ibu_787.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/colorado-vintage-black-rapadura_787.jpeg" alt="" class="imagequery popular">
