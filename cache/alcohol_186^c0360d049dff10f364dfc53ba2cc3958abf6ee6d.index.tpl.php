...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c920686e1b91_34349641',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c920686e1b91_34349641')) {function content_54c920686e1b91_34349641($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Plevnan Siperia Imperial Stout - Beer Imperial Stout from Tampere, Finland</title>
        <meta name="description" content="Discover and share more Beer, Liquor, Vodka from Finland">
		<meta name="keywords" content="Plevnan Siperia Imperial Stout, Plevnan Siperia Imperial Stout Koskipanimo, Finland Beer, Finland Imperial Stout Beer, Plevnan Siperia Imperial Stout 8 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/finland-alcohols">Finland</a></li>
	
	<li class="active"><a href="#"><b>Plevnan Siperia Imperial Stout</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-20 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/plevnan-siperia-imperial-stout_793.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Plevnan Siperia Imperial Stout</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Brewery: Koskipanimo<br>
		Brewed in: Tampere, Finland<br><br>
		ABV: <b>8</b> %
	...
	<div class="xlarge-30 large-30 medium-50 small-100"> 
			...
			<fieldset>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="186" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="186" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="186" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="186" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="186" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Finland ? Feel free to share it with us </h5>
		<a href="submit.php?country=finland" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Finland </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="koff-porter_finland-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/koff-porter_793.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Koff Porter</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="laitilan-kievari-imperiaali_finland-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/laitilan-kievari-imperiaali_793.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Laitilan Kievari Imperiaali</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="koskenkorva-viina_finland-liquor">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/koskenkorva-viina_793.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Koskenkorva Viina</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="finlandia_finland-vodka">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/finlandia_793.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Finlandia</figcaption>
		</figure></a>                        
		</div>
	</div>
