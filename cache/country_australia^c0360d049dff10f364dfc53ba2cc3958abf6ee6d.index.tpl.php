...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9ac2335aa66_42504295',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9ac2335aa66_42504295')) {function content_54c9ac2335aa66_42504295($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Australia Alcohols: Discover the best alcohols (Beer, Rum) from Australia</title>
        <meta name="description" content="Discover and share local Beer, Rum from Australia">
		<meta name="keywords" content="Australia alcohols, alcohol Australia, Beer Australia, Rum Australia, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Australia Alcohols: Discover best Beer, Rum from Australia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Australia.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Rum from Australia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/australia-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Australia</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="murrays-wild-thing-imperial-stout_australia-beer">Murrays Wild Thing Imperial Stout</a></li>
														<li><a href="nogne-o-aurora-australis_australia-beer">Nøgne Ø Aurora Australis</a></li>
														<li><a href="mornington-peninsula-russian-imperial-stout_australia-beer">Mornington Peninsula Russian Imperial Stout</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Rum (1)" class="item_link">Rum (1)</a>
						<ul class="submenu">
														<li><a href="bundaberg_australia-rum">Bundaberg</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Australia.png" /><br>
Capital: <b>Canberra</b><br>
Population: <b>23,716,600</b><br>
<div id="country_details">
Surface: <b>7,692,024 km²</b><br>
Currency: <b>AUD</b><br>
Motto: <b>« Advance Australia »</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Beer, Rum</b><br>
</div>
</div>
	</div>
</div>
<div class="ink-alert basic warning all-60 small-100">
<h5>Do you know any other local alcohol from Australia ? Feel free to share it with us </h5>
<a href="submit.php?country=australia" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Australia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="murrays-wild-thing-imperial-stout_australia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/murrays-wild-thing-imperial-stout_785.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Murrays Wild Thing Imperial Stout</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="mornington-peninsula-russian-imperial-stout_australia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/mornington-peninsula-russian-imperial-stout_785.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Mornington Peninsula Russian Imperial Stout</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="bundaberg_australia-rum">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/bundaberg_785.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Bundaberg</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="nogne-o-aurora-australis_australia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/nogne-o-aurora-australis_785.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Nøgne Ø Aurora Australis</figcaption>
		</figure></a>                        
		</div>
	</div>
