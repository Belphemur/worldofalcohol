...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c991bfc969e5_10753838',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c991bfc969e5_10753838')) {function content_54c991bfc969e5_10753838($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Oldbridž Black Devil Russian Imperial Stout - Beer Imperial Stout from Mostar, Bosnia and Herzegovina</title>
        <meta name="description" content="Discover and share more Beer from Bosnia and Herzegovina">
		<meta name="keywords" content="Oldbridž Black Devil Russian Imperial Stout, Oldbridž Black Devil Russian Imperial Stout Pivara Oldbridž, Bosnia and Herzegovina Beer, Bosnia and Herzegovina Imperial Stout Beer, Oldbridž Black Devil Russian Imperial Stout 9.99 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Oldbridž Black Devil Russian Imperial Stout Beer from Mostar, Bosnia and Herzegovina - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/oldbridz-black-devil-russian-imperial-stout_787.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer from Bosnia and Herzegovina"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/oldbridz-black-devil-russian-imperial-stout_bosnia-and-herzegovina-beer"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/bosnia-and-herzegovina-alcohols">Bosnia and Herzegovina</a></li>
	
	<li class="active"><a href="#"><b>Oldbridž Black Devil Russian Imperial Stout</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/oldbridz-black-devil-russian-imperial-stout_787.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Oldbridž Black Devil Russian Imperial Stout</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Brewery: Pivara Oldbridž<br>
		Brewed in: Mostar, Bosnia and Herzegovina<br><br>
		ABV: <b>9.99</b> %
		</div>
		<br>
 ...
 Ratings)</span>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="64" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="64" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="64" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="64" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="64" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Bosnia and Herzegovina ? Feel free to share it with us </h5>
		<a href="submit.php?country=bosnia-and-herzegovina" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Bosnia and Herzegovina </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="crni-dorde_bosnia-and-herzegovina-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/crni-dorde_787.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Crni Ðorde</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="prima-bozicno_bosnia-and-herzegovina-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/prima-bozicno_787.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Prima Božicno</figcaption>
		</figure></a>                        
		</div>
	</div>
