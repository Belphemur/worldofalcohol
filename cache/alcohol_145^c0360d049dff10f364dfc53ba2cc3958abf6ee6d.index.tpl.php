...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca060c5f3572_85173697',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca060c5f3572_85173697')) {function content_54ca060c5f3572_85173697($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Becherovka - Becherovka NA from Karlovy Vary, Czech Republic</title>
        <meta name="description" content="Discover and share more Becherovka, Beer, Slivovitz from Czech Republic">
		<meta name="keywords" content="Becherovka, Becherovka Pernod Ricard, Czech Republic Becherovka, Czech Republic NA Becherovka, Becherovka 38 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Becherovka Becherovka from Karlovy Vary, Czech Republic - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/becherovka_791.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Becherovka, Beer, Slivovitz from Czech Republic"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/becherovka_czech-republic-becherovka"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Becherovka</b></a></li>
	</ul>
	</nav>
</header>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Brewed in: Karlovy Vary, Czech Republic<br><br>
		ABV: <b>38</b> %
		</div>
		<br>
	...
	<div class="xlarge-30 large-30 medium-50 small-100"> 
		<form class="ink-form">
			<fieldset>
				<legend>Rate this Becherovka</legend>
				<?php $_smarty_tpl->smarty->_tag_stack[] = array('dynamic', array()); $_block_repeat=true; echo smarty_block_dynamic(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
 ...
 Ratings)</span>
				...
				<div class="control-group">
					<p class="label">Have you tried this Becherovka already? Let us know your opinion</p>
					<div id="rating_options">
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="145" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="145" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="145" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="145" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="145" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
...
<div class="column-group gutters"> 
		...
		<a href="zlata-raketa-golden-rocket-17_czech-republic-beer">
		<figure class="ink-image">
