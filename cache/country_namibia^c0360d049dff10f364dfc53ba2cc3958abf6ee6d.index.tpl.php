...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c98f9c947907_44078473',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c98f9c947907_44078473')) {function content_54c98f9c947907_44078473($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Namibia Alcohols: Discover the best alcohols (Beer, Mataku) from Namibia</title>
        <meta name="description" content="Discover and share local Beer from Namibia">
		<meta name="keywords" content="Namibia alcohols, alcohol Namibia, Beer Namibia, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Namibia Alcohols: Discover best Beer, Mataku from Namibia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Namibia.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer from Namibia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/namibia-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Namibia</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="hansa-urbock_namibia-beer">Hansa Urbock</a></li>
														<li><a href="camelthorn-red_namibia-beer">Camelthorn Red</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Namibia.png" /><br>
Capital: <b>Windhoek</b><br>
Population: <b>2,113,077</b><br>
<div id="country_details">
Surface: <b>825,615 km²</b><br>
Currency: <b>NAD</b><br>
Motto: <b>« Unity, liberty, justice »</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Beer, Mataku</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=namibia" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Namibia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="hansa-urbock_namibia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/hansa-urbock_191.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Hansa Urbock</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="camelthorn-red_namibia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/camelthorn-red_193.jpeg" alt="" class="imagequery popular">
