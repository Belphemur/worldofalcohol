...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c94d67341507_39250416',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c94d67341507_39250416')) {function content_54c94d67341507_39250416($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Antigua and Barbuda Alcohols: Discover the best alcohols (Rum) from Antigua and Barbuda</title>
        <meta name="description" content="Discover and share local Beer, Rum from Antigua and Barbuda">
		<meta name="keywords" content="Antigua and Barbuda alcohols, alcohol Antigua and Barbuda, Beer Antigua and Barbuda, Rum Antigua and Barbuda, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Antigua and Barbuda Alcohols: Discover best Rum from Antigua and Barbuda - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Antigua.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Rum from Antigua and Barbuda"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/antigua-and-barbuda-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Antigua and Barbuda</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
									<li class="menu_id">
						<a href="#Beer (1)" class="item_link">Beer (1)</a>
						<ul class="submenu">
														<li><a href="wadadli_antigua-and-barbuda-beer">Wadadli</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Rum (1)" class="item_link">Rum (1)</a>
						<ul class="submenu">
														<li><a href="english-harbour-rum_antigua-and-barbuda-rum">English Harbour Rum</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Antigua.png" /><br>
Capital: <b>St. John's</b><br>
Population: <b>86,295</b><br>
<div id="country_details">
Surface: <b>442 km²</b><br>
Currency: <b>XCD</b><br>
Motto: <b>« Each endeavouring, all achieving »</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Rum</b><br>
</div>
</div>
...
<h5>Do you know any other local alcohol from Antigua and Barbuda ? Feel free to share it with us </h5>
<a href="submit.php?country=antigua-and-barbuda" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Antigua and Barbuda </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="wadadli_antigua-and-barbuda-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/wadadli_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Wadadli</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="english-harbour-rum_antigua-and-barbuda-rum">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/english-harbour-rum_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">English Harbour Rum</figcaption>
		</figure></a>                        
		</div>
	</div>
