...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca200a1201d8_57431634',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca200a1201d8_57431634')) {function content_54ca200a1201d8_57431634($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Iran Alcohols: Discover the best alcohols (Arak) from Iran</title>
        <meta name="description" content="Discover and share local Beer from Iran">
		<meta name="keywords" content="Iran alcohols, alcohol Iran, Beer Iran, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Iran Alcohols: Discover best Arak from Iran - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Iran.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer from Iran"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/iran-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Iran</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="iran-shams-lemon-mint_iran-beer">Iran Shams Lemon Mint</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Iran.png" /><br>
Capital: <b>Tehran</b><br>
Population: <b>78,054,800</b><br>
<div id="country_details">
Surface: <b>1,648,195 km²</b><br>
Currency: <b>IRR</b><br>
Motto: <b>De facto: استقلال، آزادى، جمهورى اسلامى (Esteqlāl, āzādī, jomhūrī-ye eslāmī) (Persian, « Independence, freedom, (the) Islamic Republic »), De jure: الله اکبر (Allaho Akbar) (Arabic, « God is the Greatest »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Arak</b><br>
	Other Infos: <b>Almost entirely illegal</b>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=iran" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Iran </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="iran-shams-lemon-mint_iran-beer">
