...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c957e2d6b222_36164304',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c957e2d6b222_36164304')) {function content_54c957e2d6b222_36164304($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Azerbaijan Alcohols: Discover the best alcohols (None) from Azerbaijan</title>
        <meta name="description" content="Discover and share local Beer from Azerbaijan">
		<meta name="keywords" content="Azerbaijan alcohols, alcohol Azerbaijan, Beer Azerbaijan, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Azerbaijan Alcohols: Discover best None from Azerbaijan - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Azerbaijan.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer from Azerbaijan"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/azerbaijan-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Azerbaijan</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="novxani-pilsener-zlaty_azerbaijan-beer">Novxani Pilsener Zlatý</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Azerbaijan.png" /><br>
Capital: <b>Baku</b><br>
Population: <b>9,552,500</b><br>
<div id="country_details">
Surface: <b>86,600 km²</b><br>
Currency: <b>AZN</b><br>
Motto: <b>Odlar Yurdu (« The Land of Fire »)</b><br><br>
...
<h5>Do you know any other local alcohol from Azerbaijan ? Feel free to share it with us </h5>
<a href="submit.php?country=azerbaijan" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Azerbaijan </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="novxani-pilsener-zlaty_azerbaijan-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/novxani-pilsener-zlaty_785.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Novxani Pilsener Zlatý</figcaption>
		</figure></a>                        
		</div>
	</div>
