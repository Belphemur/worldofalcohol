...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca1c935176c7_06318520',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca1c935176c7_06318520')) {function content_54ca1c935176c7_06318520($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Mean Sardine Amura - Beer American Pale Ale from Mafra, Portugal</title>
        <meta name="description" content="Discover and share more Beer, Liquor, Port Wine from Portugal">
		<meta name="keywords" content="Mean Sardine Amura, Mean Sardine Amura Mean Sardine Brewery, Portugal Beer, Portugal American Pale Ale Beer, Mean Sardine Amura 6 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Mean Sardine Amura Beer from Mafra, Portugal - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/mean-sardine-amura_197.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer, Liquor, Port Wine from Portugal"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/mean-sardine-amura_portugal-beer"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/portugal-alcohols">Portugal</a></li>
	
	<li class="active"><a href="#"><b>Mean Sardine Amura</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/mean-sardine-amura_197.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Mean Sardine Amura</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Beer<br>
		Genre: American Pale Ale<br>
		Brewery: Mean Sardine Brewery<br>
		Brewed in: Mafra, Portugal<br><br>
		ABV: <b>6</b> %
		</div>
		<br>
 ...
 Ratings)</span>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="453" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="453" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="453" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="453" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="453" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Portugal ? Feel free to share it with us </h5>
		<a href="submit.php?country=portugal" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Portugal </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="ginjinha_portugal-liquor">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/ginjinha_799.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Ginjinha</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="passarola-ipa_portugal-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/passarola-ipa_197.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Passarola IPA</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="cerveja-cristal_portugal-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/cerveja-cristal_197.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Cerveja Cristal</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="white_portugal-port-wine">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/white_799.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">White</figcaption>
		</figure></a>                        
		</div>
	</div>
