...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c95487d95d40_91534955',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c95487d95d40_91534955')) {function content_54c95487d95d40_91534955($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Cameroon Alcohols: Discover the best alcohols (Bil-bil, Palm Wine, Afofo) from Cameroon</title>
        <meta name="description" content="Discover and share local Beer from Cameroon">
		<meta name="keywords" content="Cameroon alcohols, alcohol Cameroon, Beer Cameroon, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Cameroon Alcohols: Discover best Bil-bil, Palm Wine, Afofo from Cameroon - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Cameroon.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer from Cameroon"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/cameroon-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Cameroon</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="beaufort-89_cameroon-beer">Beaufort 8.9</a></li>
														<li><a href="satzenbrau_cameroon-beer">Satzenbrau</a></li>
														<li><a href="mutzig_cameroon-beer">Mützig</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Cameroon.png" /><br>
Capital: <b>Yaoundé</b><br>
Population: <b>21,143,237</b><br>
<div id="country_details">
Surface: <b>475,442 km²</b><br>
Currency: <b>XAF</b><br>
Motto: <b>Paix - Travail - Patrie (French, « Peace, Work, Fatherland »)</b><br><br>
Drinking age: <b>21</b><br>
National Alcohols: <b>Bil-bil, Palm Wine, Afofo</b><br>
</div>
</div>
...
<a href="submit.php?country=cameroon" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Cameroon </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="beaufort-89_cameroon-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/beaufort-89_788.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Beaufort 8.9</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="satzenbrau_cameroon-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/satzenbrau_788.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/mutzig_788.jpeg" alt="" class="imagequery popular">
