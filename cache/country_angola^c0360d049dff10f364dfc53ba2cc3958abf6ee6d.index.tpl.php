...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c96930105f97_50046415',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c96930105f97_50046415')) {function content_54c96930105f97_50046415($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Angola Alcohols: Discover the best alcohols (Capatica, Caporoto, Ocisangua) from Angola</title>
        <meta name="description" content="Discover and share local Beer from Angola">
		<meta name="keywords" content="Angola alcohols, alcohol Angola, Beer Angola, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Angola Alcohols: Discover best Capatica, Caporoto, Ocisangua from Angola - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Angola.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer from Angola"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/angola-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Angola</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="mongozo-palmnut_angola-beer">Mongozo Palmnut</a></li>
														<li><a href="nova-cuca_angola-beer">Nova Cuca</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Angola.png" /><br>
Capital: <b>Luanda</b><br>
Population: <b>24,383,301</b><br>
<div id="country_details">
Surface: <b>1,246,700 km²</b><br>
Currency: <b>AOA</b><br>
Motto: <b>Virtus unita fortior (Latin, « Virtus is stronger when united »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Capatica, Caporoto, Ocisangua</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=angola" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Angola </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="nova-cuca_angola-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/nova-cuca_784.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/mongozo-palmnut_784.jpeg" alt="" class="imagequery popular">
