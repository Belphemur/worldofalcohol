...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c91c853fba85_71066431',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c91c853fba85_71066431')) {function content_54c91c853fba85_71066431($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Philippines Alcohols: Discover the best alcohols (Palm Wine, Lambanog, Basi) from Philippines</title>
        <meta name="description" content="Discover and share local Arak, Basi, Beer from Philippines">
		<meta name="keywords" content="Philippines alcohols, alcohol Philippines, Arak Philippines, Basi Philippines, Beer Philippines, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Philippines</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
									<li class="menu_id">
						<a href="#Arak (1)" class="item_link">Arak (1)</a>
						<ul class="submenu">
														<li><a href="lambanog_philippines-arak">Lambanog</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Basi (1)" class="item_link">Basi (1)</a>
						<ul class="submenu">
														<li><a href="basi-del-diablo_philippines-basi">Basi del Diablo</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Beer (2)" class="item_link">Beer (2)</a>
						<ul class="submenu">
														<li><a href="san-miguel-dark-lager_philippines-beer">San Miguel Dark Lager</a></li>
														<li><a href="brew-kettle_philippines-beer">Brew Kettle</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Phil.png" /><br>
Capital: <b>Manila</b><br>
Population: <b>100,875,600</b><br>
<div id="country_details">
Surface: <b>342,353 km²</b><br>
Currency: <b>PHP</b><br>
Motto: <b>Maka-Diyos, Maka-Tao, Makakalikasan at Makabansa (Tagalog, « For God, People, Nature and Country »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Palm Wine, Lambanog, Basi</b><br>
</div>
</div>
...
<h5>Do you know any other local alcohol from Philippines ? Feel free to share it with us </h5>
<a href="submit.php?country=philippines" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Philippines </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="lambanog_philippines-arak">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/lambanog_798.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Lambanog</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="basi-del-diablo_philippines-basi">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/basi-del-diablo_798.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Basi del Diablo</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="san-miguel-dark-lager_philippines-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/san-miguel-dark-lager_197.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">San Miguel Dark Lager</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="brew-kettle_philippines-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/brew-kettle_197.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Brew Kettle</figcaption>
		</figure></a>                        
		</div>
	</div>
