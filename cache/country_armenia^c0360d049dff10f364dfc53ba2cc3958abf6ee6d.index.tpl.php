...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c96635d413a6_69474128',
  'variables' => 
  array (
    'meta' => 0,
    'meta_property_og' => 0,
...
<?php if ($_valid && !is_callable('content_54c96635d413a6_69474128')) {function content_54c96635d413a6_69474128($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Armenia Alcohols: Discover the best alcohols (Oghi, Wine) from Armenia</title>
        <meta name="description" content="Discover and share local Beer, Oghi, Raki from Armenia">
		<meta name="keywords" content="Armenia alcohols, alcohol Armenia, Beer Armenia, Oghi Armenia, Raki Armenia, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Armenia Alcohols: Discover best Oghi, Wine from Armenia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Armenia.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Oghi, Raki from Armenia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/armenia-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Armenia</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="kotayk-gold_armenia-beer">Kotayk Gold</a></li>
														<li><a href="kilikia-dymchatoe-temnoe_armenia-beer">Kilikia Dymchatoe Temnoe</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Oghi (1)" class="item_link">Oghi (1)</a>
						<ul class="submenu">
														<li><a href="artsakh_armenia-oghi">Artsakh</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Raki (1)" class="item_link">Raki (1)</a>
						<ul class="submenu">
														<li><a href="ararat-nairi-20-years_armenia-raki">Ararat Nairi 20 years</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Armenia.png" /><br>
Capital: <b>Yerevan</b><br>
Population: <b>3,013,900</b><br>
<div id="country_details">
Surface: <b>29,843 km²</b><br>
Currency: <b>AMD</b><br>
Motto: <b>Մեկ Ազգ, Մեկ Մշակույթ (Mek Azg, Mek Mshakouyt) (Armenian, « One Nation, One Culture »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Oghi, Wine</b><br>
</div>
</div>
...
<h5>Do you know any other local alcohol from Armenia ? Feel free to share it with us </h5>
<a href="submit.php?country=armenia" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Armenia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="kotayk-gold_armenia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/kotayk-gold_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Kotayk Gold</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="kilikia-dymchatoe-temnoe_armenia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/kilikia-dymchatoe-temnoe_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Kilikia Dymchatoe Temnoe</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="artsakh_armenia-oghi">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/artsakh_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Artsakh</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="ararat-nairi-20-years_armenia-raki">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/ararat-nairi-20-years_803.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Ararat Nairi 20 years</figcaption>
		</figure></a>                        
		</div>
	</div>
