...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c991b73bf3d3_36673915',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c991b73bf3d3_36673915')) {function content_54c991b73bf3d3_36673915($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Crni Ðorde - Beer Dunkel from Banja Luka, Bosnia and Herzegovina</title>
        <meta name="description" content="Discover and share more Beer from Bosnia and Herzegovina">
		<meta name="keywords" content="Crni Ðorde, Crni Ðorde Banjalucka Pivara, Bosnia and Herzegovina Beer, Bosnia and Herzegovina Dunkel Beer, Crni Ðorde 5 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Crni Ðorde Beer from Banja Luka, Bosnia and Herzegovina - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/crni-dorde_787.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer from Bosnia and Herzegovina"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/crni-dorde_bosnia-and-herzegovina-beer"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Crni Ðorde</b></a></li>
	</ul>
	</nav>
</header>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Beer<br>
		Genre: Dunkel<br>
		Brewery: Banjalucka Pivara<br>
		Brewed in: Banja Luka, Bosnia and Herzegovina<br><br>
		ABV: <b>5</b> %
		</div>
		<br>
 ...
 Ratings)</span>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="65" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="65" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="65" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="65" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="65" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
