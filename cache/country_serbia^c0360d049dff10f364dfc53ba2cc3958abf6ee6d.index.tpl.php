...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c98f096002b4_98652103',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c98f096002b4_98652103')) {function content_54c98f096002b4_98652103($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Serbia Alcohols: Discover the best alcohols (Rakija, Vinjak) from Serbia</title>
        <meta name="description" content="Discover and share local Beer, Brandy, Rakia from Serbia">
		<meta name="keywords" content="Serbia alcohols, alcohol Serbia, Beer Serbia, Brandy Serbia, Rakia Serbia, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Serbia Alcohols: Discover best Rakija, Vinjak from Serbia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Serbia.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Brandy, Rakia from Serbia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/serbia-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Serbia</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="kabinet-supernova_serbia-beer">Kabinet SuperNova</a></li>
														<li><a href="krugher-brent-extra-stout_serbia-beer">Krugher & Brent Extra Stout</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Brandy (1)" class="item_link">Brandy (1)</a>
						<ul class="submenu">
														<li><a href="vinjak_serbia-brandy">Vinjak</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Rakia (1)" class="item_link">Rakia (1)</a>
						<ul class="submenu">
														<li><a href="jelicki-dukat_serbia-rakia">Jelicki Dukat</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Serbia.png" /><br>
Capital: <b>Belgrade</b><br>
Population: <b>7,146,759</b><br>
<div id="country_details">
Surface: <b>88,361 km²</b><br>
Currency: <b>RSD</b><br>
Motto: <b>No official motto</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Rakija, Vinjak</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=serbia" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Serbia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="kabinet-supernova_serbia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/kabinet-supernova_203.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/krugher-brent-extra-stout_203.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/vinjak_800.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/jelicki-dukat_800.jpeg" alt="" class="imagequery popular">
