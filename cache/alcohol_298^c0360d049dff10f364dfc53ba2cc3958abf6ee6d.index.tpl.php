...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c98f1e27f677_29756468',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c98f1e27f677_29756468')) {function content_54c98f1e27f677_29756468($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Jelicki Dukat - Rakia NA from Cacak, Serbia</title>
        <meta name="description" content="Discover and share more Beer, Brandy, Rakia from Serbia">
		<meta name="keywords" content="Jelicki Dukat, Jelicki Dukat JELICKI DUKAT, Serbia Rakia, Serbia NA Rakia, Jelicki Dukat 40 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Jelicki Dukat Rakia from Cacak, Serbia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/jelicki-dukat_800.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer, Brandy, Rakia from Serbia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/jelicki-dukat_serbia-rakia"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/serbia-alcohols">Serbia</a></li>
	
	<li class="active"><a href="#"><b>Jelicki Dukat</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/jelicki-dukat_800.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Jelicki Dukat</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Rakia<br>
		Genre: NA<br>
		Brewery: JELICKI DUKAT<br>
		Brewed in: Cacak, Serbia<br><br>
		ABV: <b>40</b> %
		</div>
		<br>
...
">
 ...
 Ratings)</span>
				...
				<div class="control-group">
					<p class="label">Have you tried this Rakia already? Let us know your opinion</p>
					<div id="rating_options">
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="298" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="298" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="298" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="298" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="298" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Serbia ? Feel free to share it with us </h5>
		<a href="submit.php?country=serbia" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Serbia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="kabinet-supernova_serbia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/kabinet-supernova_203.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Kabinet SuperNova</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="krugher-brent-extra-stout_serbia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/krugher-brent-extra-stout_203.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Krugher & Brent Extra Stout</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="vinjak_serbia-brandy">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/vinjak_800.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Vinjak</figcaption>
		</figure></a>                        
		</div>
	</div>
