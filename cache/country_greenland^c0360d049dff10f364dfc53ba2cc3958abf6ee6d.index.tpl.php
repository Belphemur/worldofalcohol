...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca0c168eb808_46116325',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca0c168eb808_46116325')) {function content_54ca0c168eb808_46116325($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Greenland Alcohols: Discover the best alcohols (None) from Greenland</title>
        <meta name="description" content="Discover and share local Beer from Greenland">
		<meta name="keywords" content="Greenland alcohols, alcohol Greenland, Beer Greenland, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Greenland Alcohols: Discover best None from Greenland - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Green.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer from Greenland"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/greenland-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Greenland</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="greenland-easter-bock_greenland-beer">Greenland Easter Bock</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Green.png" /><br>
Capital: <b>Nuuk</b><br>
Population: <b>56,295</b><br>
<div id="country_details">
Surface: <b>2,166,086 km²</b><br>
Currency: <b>DKK</b><br>
...
<a href="submit.php?country=greenland" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Greenland </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="greenland-easter-bock_greenland-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/greenland-easter-bock_118.jpeg" alt="" class="imagequery popular">
