...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c94f6cc02c93_12300400',
  'variables' => 
  array (
    'meta' => 0,
    'meta_property_og' => 0,
...
<?php if ($_valid && !is_callable('content_54c94f6cc02c93_12300400')) {function content_54c94f6cc02c93_12300400($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Hinano Ambrée - Beer Amber Lager from Papeete, French Polynesia</title>
        <meta name="description" content="Discover and share more Beer from French Polynesia">
		<meta name="keywords" content="Hinano Ambrée, Hinano Ambrée La Brasserie de Tahiti, French Polynesia Beer, French Polynesia Amber Lager Beer, Hinano Ambrée 5 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Hinano Ambrée Beer from Papeete, French Polynesia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/hinano-ambree_794.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer from French Polynesia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/hinano-ambree_french-polynesia-beer"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/french-polynesia-alcohols">French Polynesia</a></li>
	
	<li class="active"><a href="#"><b>Hinano Ambrée</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-20 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/hinano-ambree_794.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Hinano Ambrée</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Beer<br>
		Genre: Amber Lager<br>
		Brewery: La Brasserie de Tahiti<br>
		Brewed in: Papeete, French Polynesia<br><br>
		ABV: <b>5</b> %
	...
	<div class="xlarge-30 large-30 medium-50 small-100"> 
			...
			<fieldset>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="203" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="203" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="203" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="203" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="203" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from French Polynesia ? Feel free to share it with us </h5>
		<a href="submit.php?country=french-polynesia" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from French Polynesia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="tabu_french-polynesia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/tabu_794.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Tabu</figcaption>
		</figure></a>                        
		</div>
	</div>
