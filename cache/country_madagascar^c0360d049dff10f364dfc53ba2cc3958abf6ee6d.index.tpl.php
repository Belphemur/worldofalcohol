...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca1c8c6fc0d3_77187454',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca1c8c6fc0d3_77187454')) {function content_54ca1c8c6fc0d3_77187454($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Madagascar Alcohols: Discover the best alcohols (Wine, Litchel) from Madagascar</title>
        <meta name="description" content="Discover and share local Beer, Rum from Madagascar">
		<meta name="keywords" content="Madagascar alcohols, alcohol Madagascar, Beer Madagascar, Rum Madagascar, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Madagascar Alcohols: Discover best Wine, Litchel from Madagascar - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Madagascar.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Rum from Madagascar"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/madagascar-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Madagascar</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="star-gold-blonde_madagascar-beer">Star Gold Blonde</a></li>
														<li><a href="libertalia-original-beer_madagascar-beer">Libertalia Original Beer</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Rum (1)" class="item_link">Rum (1)</a>
						<ul class="submenu">
														<li><a href="dzame-xv-15-ans_madagascar-rum">Dzame XV 15 ans</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Madagascar.png" /><br>
Capital: <b>Antananarivo</b><br>
Population: <b>21,842,167</b><br>
<div id="country_details">
Surface: <b>587,041 km²</b><br>
Currency: <b>MGA</b><br>
Motto: <b>Fitiavana, Tanindrazana, Fandrosoana (Malagasy, « Love, Ancestral-land, Progress »)</b><br><br>
Drinking age: <b>No legislation</b><br>
National Alcohols: <b>Wine, Litchel</b><br>
</div>
</div>
	</div>
</div>
<div class="ink-alert basic warning all-60 small-100">
<h5>Do you know any other local alcohol from Madagascar ? Feel free to share it with us </h5>
<a href="submit.php?country=madagascar" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Madagascar </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="star-gold-blonde_madagascar-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/star-gold-blonde_189.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Star Gold Blonde</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="libertalia-original-beer_madagascar-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/libertalia-original-beer_189.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Libertalia Original Beer</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="dzame-xv-15-ans_madagascar-rum">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/dzame-xv-15-ans_797.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Dzame XV 15 ans</figcaption>
		</figure></a>                        
		</div>
	</div>
