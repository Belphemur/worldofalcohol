...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9b9f181bac6_80177471',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9b9f181bac6_80177471')) {function content_54c9b9f181bac6_80177471($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Costa Rica Alcohols: Discover the best alcohols (Guaro) from Costa Rica</title>
        <meta name="description" content="Discover and share local Beer, Guaro from Costa Rica">
		<meta name="keywords" content="Costa Rica alcohols, alcohol Costa Rica, Beer Costa Rica, Guaro Costa Rica, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Costa Rica Alcohols: Discover best Guaro from Costa Rica - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Costa.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Guaro from Costa Rica"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/costa-rica-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Costa Rica</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="segua-red-ale_costa-rica-beer">Segua Red Ale</a></li>
														<li><a href="witch-s-rock-pale-ale_costa-rica-beer">Witch’s Rock Pale Ale</a></li>
														<li><a href="tumba-calzones_costa-rica-beer">Tumba Calzones</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Guaro (1)" class="item_link">Guaro (1)</a>
						<ul class="submenu">
														<li><a href="cacique-guaro_costa-rica-guaro">Cacique Guaro</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Costa.png" /><br>
Capital: <b>San José</b><br>
Population: <b>4,773,130</b><br>
<div id="country_details">
Surface: <b>51,100 km²</b><br>
Currency: <b>CRC</b><br>
Motto: <b>Vivan siempre el trabajo y la paz (Spanish, « Long live work and peace »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Guaro</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=costa-rica" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Costa Rica </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="segua-red-ale_costa-rica-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/segua-red-ale_790.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/witch-s-rock-pale-ale_790.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/tumba-calzones_790.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/cacique-guaro_790.jpeg" alt="" class="imagequery popular">
