...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca1cdc2d8422_52274621',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca1cdc2d8422_52274621')) {function content_54ca1cdc2d8422_52274621($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Tatratea Original - Liquor NA from Cifer, Slovakia</title>
        <meta name="description" content="Discover and share more Beer, Liquor from Slovakia">
		<meta name="keywords" content="Tatratea Original, Tatratea Original Karloff, Slovakia Liquor, Slovakia NA Liquor, Tatratea Original 52 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Tatratea Original Liquor from Cifer, Slovakia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/tatratea-original_800.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer, Liquor from Slovakia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/tatratea-original_slovakia-liquor"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/slovakia-alcohols">Slovakia</a></li>
	
	<li class="active"><a href="#"><b>Tatratea Original</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/tatratea-original_800.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Tatratea Original</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Genre: NA<br>
		Brewery: Karloff<br>
		Brewed in: Cifer, Slovakia<br><br>
		ABV: <b>52</b> %
		</div>
		<br>
 ...
 Ratings)</span>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="302" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="302" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="302" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="302" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="302" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Slovakia ? Feel free to share it with us </h5>
		<a href="submit.php?country=slovakia" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Slovakia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="hellstork-kraken-ipa-19_slovakia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/hellstork-kraken-ipa-19_204.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Hellstork Kraken IPA 19°</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="kaltenecker-chopper-ipa-grand-champion-2012_slovakia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/kaltenecker-chopper-ipa-grand-champion-2012_204.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Kaltenecker Chopper IPA Grand Champion 2012</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="sessler-tmavy-special-21_slovakia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/sessler-tmavy-special-21_204.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Sessler Tmavý Špeciál 21°</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="spisska-borovicka_slovakia-liquor">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/spisska-borovicka_800.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Spišská borovicka</figcaption>
		</figure></a>                        
		</div>
	</div>
