...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9dd3e8f9964_28917581',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9dd3e8f9964_28917581')) {function content_54c9dd3e8f9964_28917581($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Argentina Alcohols: Discover the best alcohols (Fernet, Wine) from Argentina</title>
        <meta name="description" content="Discover and share local Beer, Fernet from Argentina">
		<meta name="keywords" content="Argentina alcohols, alcohol Argentina, Beer Argentina, Fernet Argentina, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Argentina Alcohols: Discover best Fernet, Wine from Argentina - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Argentina.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Fernet from Argentina"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/argentina-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Argentina</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="murrays-ipa_argentina-beer">Murrays IPA</a></li>
														<li><a href="araucana-rojiza-fuerte_argentina-beer">Araucana Rojiza Fuerte</a></li>
														<li><a href="antares-imperial-stout_argentina-beer">Antares Imperial Stout</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Fernet (1)" class="item_link">Fernet (1)</a>
						<ul class="submenu">
														<li><a href="fernet-1882_argentina-fernet">Fernet 1882</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Argentina.png" /><br>
Capital: <b>Buenos Aires</b><br>
Population: <b>43,131,966</b><br>
<div id="country_details">
Surface: <b>2,780,400 km²</b><br>
Currency: <b>ARS</b><br>
Motto: <b>En unión y libertad (Spanish, « In Union and Liberty »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Fernet, Wine</b><br>
</div>
</div>
	</div>
</div>
<div class="ink-alert basic warning all-60 small-100">
<h5>Do you know any other local alcohol from Argentina ? Feel free to share it with us </h5>
<a href="submit.php?country=argentina" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Argentina </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="murrays-ipa_argentina-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/murrays-ipa_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Murrays IPA</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="araucana-rojiza-fuerte_argentina-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/araucana-rojiza-fuerte_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Araucana Rojiza Fuerte</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="antares-imperial-stout_argentina-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/antares-imperial-stout_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Antares Imperial Stout</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="fernet-1882_argentina-fernet">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/fernet-1882_784.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Fernet 1882</figcaption>
		</figure></a>                        
		</div>
	</div>
