...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca1c89ba25f7_66193456',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca1c89ba25f7_66193456')) {function content_54ca1c89ba25f7_66193456($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Portugal Alcohols: Discover the best alcohols (Ginjinha, Jeropiga, Port Wine) from Portugal</title>
        <meta name="description" content="Discover and share local Beer, Liquor, Port Wine from Portugal">
		<meta name="keywords" content="Portugal alcohols, alcohol Portugal, Beer Portugal, Liquor Portugal, Port Wine Portugal, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Portugal Alcohols: Discover best Ginjinha, Jeropiga, Port Wine from Portugal - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Portu.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Liquor, Port Wine from Portugal"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/portugal-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Portugal</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="mean-sardine-amura_portugal-beer">Mean Sardine Amura</a></li>
														<li><a href="passarola-ipa_portugal-beer">Passarola IPA</a></li>
														<li><a href="cerveja-cristal_portugal-beer">Cerveja Cristal</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Liquor (1)" class="item_link">Liquor (1)</a>
						<ul class="submenu">
														<li><a href="ginjinha_portugal-liquor">Ginjinha</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Port Wine (1)" class="item_link">Port Wine (1)</a>
						<ul class="submenu">
														<li><a href="white_portugal-port-wine">White</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Portu.png" /><br>
Capital: <b>Lisbon</b><br>
Population: <b>10,477,800</b><br>
<div id="country_details">
Surface: <b>92,090 km²</b><br>
Currency: <b>EUR</b><br>
Motto: <b>Esta é a Ditosa Pátria Minha Amada (Portugese, « This is my happy Motherland, beloved of mine »)</b><br><br>
Drinking age: <b>Beers & wine:16, other alcohols:18</b><br>
National Alcohols: <b>Ginjinha, Jeropiga, Port Wine</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=portugal" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Portugal </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="ginjinha_portugal-liquor">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/ginjinha_799.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/mean-sardine-amura_197.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/passarola-ipa_197.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/cerveja-cristal_197.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/white_799.jpeg" alt="" class="imagequery popular">
