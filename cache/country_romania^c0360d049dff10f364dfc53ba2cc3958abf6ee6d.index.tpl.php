...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c8171926c9d9_89886343',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c8171926c9d9_89886343')) {function content_54c8171926c9d9_89886343($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Romania Alcohols: Discover the best alcohols (Tuicapalinka) from Romania</title>
        <meta name="description" content="Discover and share local Beer, Liquor from Romania">
		<meta name="keywords" content="Romania alcohols, alcohol Romania, Beer Romania, Liquor Romania, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Romania</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="ursus-black_romania-beer">Ursus Black</a></li>
														<li><a href="clinica-de-bere-terapia-platin_romania-beer">Clinica de Bere Terapia Platin</a></li>
														<li><a href="silva-strong-dark-beer_romania-beer">Silva Strong Dark Beer</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Liquor (2)" class="item_link">Liquor (2)</a>
						<ul class="submenu">
														<li><a href="tuica_romania-liquor">Țuica</a></li>
														<li><a href="palinca-de-maramures_romania-liquor">Palinca de Maramures</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Romania.png" /><br>
Capital: <b>Bucharest</b><br>
Population: <b>19,942,642</b><br>
<div id="country_details">
Surface: <b>238,391 km²</b><br>
Currency: <b>RON</b><br>
Motto: <b>Formerly Nihil Sine Deo (Latin, « Nothing without God ») and before that Toţi în unu (Romanian, « All in one »). Currently none.</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Tuicapalinka</b><br>
</div>
</div>
...
<h5>Do you know any other local alcohol from Romania ? Feel free to share it with us </h5>
<a href="submit.php?country=romania" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Romania </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="ursus-black_romania-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/ursus-black_197.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Ursus Black</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="clinica-de-bere-terapia-platin_romania-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/clinica-de-bere-terapia-platin_197.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Clinica de Bere Terapia Platin</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="silva-strong-dark-beer_romania-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/silva-strong-dark-beer_197.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Silva Strong Dark Beer</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="tuica_romania-liquor">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/tuica_799.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Țuica</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="palinca-de-maramures_romania-liquor">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/palinca-de-maramures_799.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Palinca de Maramures</figcaption>
		</figure></a>                        
		</div>
	</div>
