...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c91e73bbf5f3_58539893',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c91e73bbf5f3_58539893')) {function content_54c91e73bbf5f3_58539893($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Democratic Republic of the Congo Alcohols: Discover the best alcohols (Beer) from Democratic Republic of the Congo</title>
        <meta name="description" content="Discover and share local Beer from Democratic Republic of the Congo">
		<meta name="keywords" content="Democratic Republic of the Congo alcohols, alcohol Democratic Republic of the Congo, Beer Democratic Republic of the Congo, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Democratic Republic of the Congo</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="tembo-biere_democratic-republic-of-the-congo-beer">Tembo Bière</a></li>
														<li><a href="doppel-munich_democratic-republic-of-the-congo-beer">Doppel Munich</a></li>
														<li><a href="turbo-king-biere-brune_democratic-republic-of-the-congo-beer">Turbo King Bière Brune</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/DRC.png" /><br>
Capital: <b>Kinshasa</b><br>
Population: <b>71,246,000</b><br>
<div id="country_details">
Surface: <b>2,344,858 km²</b><br>
Currency: <b>CDF</b><br>
Motto: <b>Justice - Paix - Travail (French, « Justice, Peace, Work »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Beer</b><br>
</div>
</div>
...
<h5>Do you know any other local alcohol from Democratic Republic of the Congo ? Feel free to share it with us </h5>
<a href="submit.php?country=democratic-republic-of-the-congo" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Democratic Republic of the Congo </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="tembo-biere_democratic-republic-of-the-congo-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/tembo-biere_790.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Tembo Bière</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="doppel-munich_democratic-republic-of-the-congo-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/doppel-munich_790.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Doppel Munich</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="turbo-king-biere-brune_democratic-republic-of-the-congo-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/turbo-king-biere-brune_790.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Turbo King Bière Brune</figcaption>
		</figure></a>                        
		</div>
	</div>
