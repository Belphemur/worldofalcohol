...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c991ae2d4cf6_53516902',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c991ae2d4cf6_53516902')) {function content_54c991ae2d4cf6_53516902($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Bosnia and Herzegovina Alcohols: Discover the best alcohols (Rakija) from Bosnia and Herzegovina</title>
        <meta name="description" content="Discover and share local Beer from Bosnia and Herzegovina">
		<meta name="keywords" content="Bosnia and Herzegovina alcohols, alcohol Bosnia and Herzegovina, Beer Bosnia and Herzegovina, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Bosnia and Herzegovina Alcohols: Discover best Rakija from Bosnia and Herzegovina - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Bosnia.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer from Bosnia and Herzegovina"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/bosnia-and-herzegovina-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Bosnia and Herzegovina</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="prima-bozicno_bosnia-and-herzegovina-beer">Prima Božicno</a></li>
														<li><a href="oldbridz-black-devil-russian-imperial-stout_bosnia-and-herzegovina-beer">Oldbridž Black Devil Russian Imperial Stout</a></li>
														<li><a href="crni-dorde_bosnia-and-herzegovina-beer">Crni Ðorde</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Bosnia.png" /><br>
Capital: <b>Sarajevo</b><br>
Population: <b>3,791,622</b><br>
<div id="country_details">
Surface: <b>51,209 km²</b><br>
Currency: <b>BAM</b><br>
...
<a href="submit.php?country=bosnia-and-herzegovina" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Bosnia and Herzegovina </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="crni-dorde_bosnia-and-herzegovina-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/crni-dorde_787.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/prima-bozicno_787.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/oldbridz-black-devil-russian-imperial-stout_787.jpeg" alt="" class="imagequery popular">
