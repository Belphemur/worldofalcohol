...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c9205b07f065_26606424',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c9205b07f065_26606424')) {function content_54c9205b07f065_26606424($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Finland Alcohols: Discover the best alcohols (Koskenkorva Viina, Finlandia Vodka, Sahti) from Finland</title>
        <meta name="description" content="Discover and share local Beer, Liquor, Vodka from Finland">
		<meta name="keywords" content="Finland alcohols, alcohol Finland, Beer Finland, Liquor Finland, Vodka Finland, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Finland</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="plevnan-siperia-imperial-stout_finland-beer">Plevnan Siperia Imperial Stout</a></li>
														<li><a href="koff-porter_finland-beer">Koff Porter</a></li>
														<li><a href="laitilan-kievari-imperiaali_finland-beer">Laitilan Kievari Imperiaali</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Liquor (1)" class="item_link">Liquor (1)</a>
						<ul class="submenu">
														<li><a href="koskenkorva-viina_finland-liquor">Koskenkorva Viina</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Vodka (1)" class="item_link">Vodka (1)</a>
						<ul class="submenu">
														<li><a href="finlandia_finland-vodka">Finlandia</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Finland.png" /><br>
Capital: <b>Helsinki</b><br>
Population: <b>5,472,421</b><br>
<div id="country_details">
Surface: <b>338,424 km²</b><br>
Currency: <b>EUR</b><br>
Motto: <b>No official motto</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Koskenkorva Viina, Finlandia Vodka, Sahti</b><br>
</div>
</div>
...
<a href="submit.php?country=finland" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Finland </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="plevnan-siperia-imperial-stout_finland-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/plevnan-siperia-imperial-stout_793.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/koff-porter_793.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/laitilan-kievari-imperiaali_793.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/koskenkorva-viina_793.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/finlandia_793.jpeg" alt="" class="imagequery popular">
