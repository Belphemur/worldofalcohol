...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c95709620585_59282075',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c95709620585_59282075')) {function content_54c95709620585_59282075($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Turkey Alcohols: Discover the best alcohols (Raki) from Turkey</title>
        <meta name="description" content="Discover and share local Beer, Raki from Turkey">
		<meta name="keywords" content="Turkey alcohols, alcohol Turkey, Beer Turkey, Raki Turkey, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Turkey Alcohols: Discover best Raki from Turkey - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Turkey.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Raki from Turkey"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/turkey-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Turkey</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="gara-guzu-amber-ale_turkey-beer">Gara Guzu Amber Ale</a></li>
														<li><a href="bosphorus-istanbul-pale-ale_turkey-beer">Bosphorus Istanbul Pale Ale</a></li>
														<li><a href="efes-dark_turkey-beer">Efes Dark</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Raki (1)" class="item_link">Raki (1)</a>
						<ul class="submenu">
														<li><a href="tekirdag-rakisi_turkey-raki">Tekirdag Rakisi</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Turkey.png" /><br>
Capital: <b>Ankara</b><br>
Population: <b>76,667,864</b><br>
<div id="country_details">
Surface: <b>783,562 km²</b><br>
Currency: <b>TRY</b><br>
Motto: <b>Egemenlik, kayıtsız şartsız milletindir! (Turkish, « Sovereignty rests unconditionally with the nation! »)</b><br><br>
...
<a href="submit.php?country=turkey" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Turkey </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="efes-dark_turkey-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/efes-dark_264.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/gara-guzu-amber-ale_252.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/bosphorus-istanbul-pale-ale_255.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Bosphorus Istanbul Pale Ale</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="tekirdag-rakisi_turkey-raki">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/tekirdag-rakisi_799.jpeg" alt="" class="imagequery popular">
