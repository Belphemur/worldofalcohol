...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c98d3a87e811_22515338',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c98d3a87e811_22515338')) {function content_54c98d3a87e811_22515338($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Tomislav Tamno Pivo - Beer Baltic Porter from Zagreb, Croatia</title>
        <meta name="description" content="Discover and share more Beer, Rakia from Croatia">
		<meta name="keywords" content="Tomislav Tamno Pivo, Tomislav Tamno Pivo Zagrebacka Pivovara (MolsonCoors), Croatia Beer, Croatia Baltic Porter Beer, Tomislav Tamno Pivo 7.3 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Tomislav Tamno Pivo Beer from Zagreb, Croatia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/tomislav-tamno-pivo_790.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer, Rakia from Croatia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/tomislav-tamno-pivo_croatia-beer"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/croatia-alcohols">Croatia</a></li>
	
	<li class="active"><a href="#"><b>Tomislav Tamno Pivo</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/tomislav-tamno-pivo_790.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Tomislav Tamno Pivo</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Brewery: Zagrebacka Pivovara (MolsonCoors)<br>
		Brewed in: Zagreb, Croatia<br><br>
		ABV: <b>7.3</b> %
		</div>
		<br>
 ...
 Ratings)</span>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="131" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="131" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="131" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="131" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="131" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Croatia ? Feel free to share it with us </h5>
		<a href="submit.php?country=croatia" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Croatia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="zmajska-pivovara-porter_croatia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/zmajska-pivovara-porter_790.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Zmajska Pivovara Porter</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="pivnica-medvedgrad-fakin-ipa_croatia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/pivnica-medvedgrad-fakin-ipa_790.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Pivnica Medvedgrad Fakin IPA</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="travarica_croatia-rakia">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/travarica_790.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Travarica</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="medica_croatia-rakia">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/medica_791.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Medica</figcaption>
		</figure></a>                        
		</div>
	</div>
