...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c954952039f0_49498765',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c954952039f0_49498765')) {function content_54c954952039f0_49498765($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Satzenbrau - Beer Pale Lager from Douala, Cameroon</title>
        <meta name="description" content="Discover and share more Beer from Cameroon">
		<meta name="keywords" content="Satzenbrau, Satzenbrau Guinness Cameroon, Cameroon Beer, Cameroon Pale Lager Beer, Satzenbrau 5.1 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Satzenbrau Beer from Douala, Cameroon - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/satzenbrau_788.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer from Cameroon"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/satzenbrau_cameroon-beer"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/cameroon-alcohols">Cameroon</a></li>
	
	<li class="active"><a href="#"><b>Satzenbrau</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/satzenbrau_788.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Satzenbrau</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Beer<br>
		Genre: Pale Lager<br>
		Brewery: Guinness Cameroon<br>
		Brewed in: Douala, Cameroon<br><br>
		ABV: <b>5.1</b> %
		</div>
		<br>
 ...
 Ratings)</span>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="89" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="89" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="89" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="89" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="89" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Cameroon ? Feel free to share it with us </h5>
		<a href="submit.php?country=cameroon" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Cameroon </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="beaufort-89_cameroon-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/beaufort-89_788.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Beaufort 8.9</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="mutzig_cameroon-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/mutzig_788.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Mützig</figcaption>
		</figure></a>                        
		</div>
	</div>
