...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca205541d799_12477752',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca205541d799_12477752')) {function content_54ca205541d799_12477752($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Gilde Non Plus Ultra Aquavit - Akvavit NA from Oslo, Norway</title>
        <meta name="description" content="Discover and share more Akvavit, Beer from Norway">
		<meta name="keywords" content="Gilde Non Plus Ultra Aquavit, Gilde Non Plus Ultra Aquavit Arcus SA Oslo, Norway Akvavit, Norway NA Akvavit, Gilde Non Plus Ultra Aquavit 41 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Gilde Non Plus Ultra Aquavit Akvavit from Oslo, Norway - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/gilde-non-plus-ultra-aquavit_797.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Akvavit, Beer from Norway"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/gilde-non-plus-ultra-aquavit_norway-akvavit"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/norway-alcohols">Norway</a></li>
	
	<li class="active"><a href="#"><b>Gilde Non Plus Ultra Aquavit</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/gilde-non-plus-ultra-aquavit_797.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Gilde Non Plus Ultra Aquavit</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Akvavit<br>
		Genre: NA<br>
		Brewery: Arcus SA Oslo<br>
		Brewed in: Oslo, Norway<br><br>
		ABV: <b>41</b> %
		</div>
		<br>
	...
	<div class="xlarge-30 large-30 medium-50 small-100"> 
		<form class="ink-form">
			<fieldset>
				<legend>Rate this Akvavit</legend>
				<?php $_smarty_tpl->smarty->_tag_stack[] = array('dynamic', array()); $_block_repeat=true; echo smarty_block_dynamic(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
 ...
 Ratings)</span>
				...
				<div class="control-group">
					<p class="label">Have you tried this Akvavit already? Let us know your opinion</p>
					<div id="rating_options">
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="262" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="262" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="262" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="262" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="262" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Norway ? Feel free to share it with us </h5>
		<a href="submit.php?country=norway" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Norway </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="loitens-sommer-aquavit_norway-akvavit">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/loitens-sommer-aquavit_797.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Løitens Sommer Aquavit</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="nogne-o-imperial-stout_norway-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/nogne-o-imperial-stout_196.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Nøgne Ø Imperial Stout</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="aegir-lynchburg-natt_norway-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/aegir-lynchburg-natt_196.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Ægir Lynchburg Natt</figcaption>
		</figure></a>                        
		</div>
	</div>
