...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c8ddf9df1a98_41247176',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c8ddf9df1a98_41247176')) {function content_54c8ddf9df1a98_41247176($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Puerto Rico Alcohols: Discover the best alcohols (Rum, Pitorro, Pina Colada) from Puerto Rico</title>
        <meta name="description" content="Discover and share local Beer, Rum from Puerto Rico">
		<meta name="keywords" content="Puerto Rico alcohols, alcohol Puerto Rico, Beer Puerto Rico, Rum Puerto Rico, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Puerto Rico</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="old-harbor-kofresi-stout_puerto-rico-beer">Old Harbor Kofresi Stout</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Rum (2)" class="item_link">Rum (2)</a>
						<ul class="submenu">
														<li><a href="pitorico-elite_puerto-rico-rum">PitoRico Elite</a></li>
														<li><a href="ron-piza_puerto-rico-rum">Ron Piza</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Puerto.png" /><br>
Capital: <b>San Juan</b><br>
Population: <b>3,548,397</b><br>
<div id="country_details">
Surface: <b>8,870 km²</b><br>
Currency: <b>USD</b><br>
Motto: <b>Joannes est nomen ejus (Latin, « John is his name »). Taken from the Vulgate translation of Luke 1:63, referring to the fact that the island's former name was San Juan (now the capital's name) in honour of Saint John the Baptist.</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Rum, Pitorro, Pina Colada</b><br>
</div>
</div>
...
<h5>Do you know any other local alcohol from Puerto Rico ? Feel free to share it with us </h5>
<a href="submit.php?country=puerto-rico" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Puerto Rico </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="old-harbor-kofresi-stout_puerto-rico-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/old-harbor-kofresi-stout_197.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Old Harbor Kofresi Stout</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="pitorico-elite_puerto-rico-rum">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/pitorico-elite_799.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">PitoRico Elite</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="ron-piza_puerto-rico-rum">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/ron-piza_799.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Ron Piza</figcaption>
		</figure></a>                        
		</div>
	</div>
