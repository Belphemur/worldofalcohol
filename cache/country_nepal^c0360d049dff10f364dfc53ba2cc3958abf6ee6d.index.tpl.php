...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c96c5327bde5_26843049',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c96c5327bde5_26843049')) {function content_54c96c5327bde5_26843049($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Nepal Alcohols: Discover the best alcohols (Chhaang, Raksi, Tongba) from Nepal</title>
        <meta name="description" content="Discover and share local Beer from Nepal">
		<meta name="keywords" content="Nepal alcohols, alcohol Nepal, Beer Nepal, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Nepal Alcohols: Discover best Chhaang, Raksi, Tongba from Nepal - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Nepal.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer from Nepal"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/nepal-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Nepal</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="coblenzer-pilsener_nepal-beer">Coblenzer Pilsener</a></li>
														<li><a href="nepal-s-mustang-premium-lager-beer_nepal-beer">Nepal’s Mustang Premium Lager Beer</a></li>
														<li><a href="everest-premium-lager_nepal-beer">Everest Premium Lager</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Nepal.png" /><br>
Capital: <b>Kathmandu</b><br>
Population: <b>28,037,904</b><br>
<div id="country_details">
Surface: <b>147,181 km²</b><br>
Currency: <b>NPR</b><br>
Motto: <b>जननी जन्मभूमिष्च स्वर्गादपि गरियसि (Janani Janmabhoomischa Swargadapi Gariyasi) (Sanskrit, « Mother and motherland are greater than heaven »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Chhaang, Raksi, Tongba</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=nepal" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Nepal </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="coblenzer-pilsener_nepal-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/coblenzer-pilsener_194.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/everest-premium-lager_195.jpeg" alt="" class="imagequery popular">
		<figcaption class="dark over-bottom">Everest Premium Lager</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="nepal-s-mustang-premium-lager-beer_nepal-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/nepal-s-mustang-premium-lager-beer_195.jpeg" alt="" class="imagequery popular">
