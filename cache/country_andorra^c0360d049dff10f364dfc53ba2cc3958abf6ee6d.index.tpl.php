...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c96272ef2172_39546581',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c96272ef2172_39546581')) {function content_54c96272ef2172_39546581($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Andorra Alcohols: Discover the best alcohols (None) from Andorra</title>
        <meta name="description" content="Discover and share local Beer, Wine from Andorra">
		<meta name="keywords" content="Andorra alcohols, alcohol Andorra, Beer Andorra, Wine Andorra, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Andorra Alcohols: Discover best None from Andorra - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Andorra.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer, Wine from Andorra"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/andorra-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Andorra</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="alpha-sant-cornelli_andorra-beer">Alpha Sant Cornelli</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Wine (1)" class="item_link">Wine (1)</a>
						<ul class="submenu">
														<li><a href="escarxat-ermita-a-la-mora_andorra-wine">Escarxat Ermita a la Mora</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Andorra.png" /><br>
Capital: <b>Andorra la Vella</b><br>
Population: <b>76,949</b><br>
<div id="country_details">
Surface: <b>468 km²</b><br>
Currency: <b>EUR</b><br>
Motto: <b>Virtus unita fortior (Latin, « Virtus is stronger when united »)</b><br><br>
...
<a href="submit.php?country=andorra" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Andorra </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="alpha-sant-cornelli_andorra-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/alpha-sant-cornelli_110.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/escarxat-ermita-a-la-mora_784.jpeg" alt="" class="imagequery popular">
