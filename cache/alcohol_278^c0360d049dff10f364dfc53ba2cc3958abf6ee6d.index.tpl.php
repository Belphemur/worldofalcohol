...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c95719094000_80698711',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c95719094000_80698711')) {function content_54c95719094000_80698711($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Tekirdag Rakisi - Raki NA from Tekirdag, Turkey</title>
        <meta name="description" content="Discover and share more Beer, Raki from Turkey">
		<meta name="keywords" content="Tekirdag Rakisi, Tekirdag Rakisi Tekirdag Rakisi, Turkey Raki, Turkey NA Raki, Tekirdag Rakisi 45 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Tekirdag Rakisi Raki from Tekirdag, Turkey - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/tekirdag-rakisi_799.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer, Raki from Turkey"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/tekirdag-rakisi_turkey-raki"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/turkey-alcohols">Turkey</a></li>
	
	<li class="active"><a href="#"><b>Tekirdag Rakisi</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-25 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/tekirdag-rakisi_799.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Tekirdag Rakisi</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Raki<br>
		Genre: NA<br>
		Brewery: Tekirdag Rakisi<br>
		Brewed in: Tekirdag, Turkey<br><br>
		ABV: <b>45</b> %
		</div>
		<br>
...
">
 ...
 Ratings)</span>
				...
				<div class="control-group">
					<p class="label">Have you tried this Raki already? Let us know your opinion</p>
					<div id="rating_options">
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="278" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="278" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="278" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="278" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="278" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Turkey ? Feel free to share it with us </h5>
		<a href="submit.php?country=turkey" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>


<h3><i class='icon-trophy'></i> Popular Alcohols from Turkey </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="efes-dark_turkey-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/efes-dark_264.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Efes Dark</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="gara-guzu-amber-ale_turkey-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/gara-guzu-amber-ale_252.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Gara Guzu Amber Ale</figcaption>
		</figure></a>                        
		</div>
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="bosphorus-istanbul-pale-ale_turkey-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/bosphorus-istanbul-pale-ale_255.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Bosphorus Istanbul Pale Ale</figcaption>
		</figure></a>                        
		</div>
	</div>
