...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c997b36cd379_91165524',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c997b36cd379_91165524')) {function content_54c997b36cd379_91165524($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Saudi Arabia Alcohols: Discover the best alcohols (None) from Saudi Arabia</title>
        <meta name="description" content="Discover and share local Beer from Saudi Arabia">
		<meta name="keywords" content="Saudi Arabia alcohols, alcohol Saudi Arabia, Beer Saudi Arabia, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Saudi Arabia Alcohols: Discover best None from Saudi Arabia - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Saudi.png"/>
		 
		<meta property="og:description" content="Discover and share local Beer from Saudi Arabia"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/saudi-arabia-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Saudi Arabia</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
						...
						<ul class="submenu">
														<li><a href="al-amoudi-rich-regular_saudi-arabia-beer">Al-Amoudi Rich Regular</a></li>
														<li><a href="bario-classic_saudi-arabia-beer">Bario Classic</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Saudi.png" /><br>
Capital: <b>Riyadh</b><br>
Population: <b>31,521,418</b><br>
<div id="country_details">
Surface: <b>2,149,690 km²</b><br>
Currency: <b>SAR</b><br>
Motto: <b>لا إله إلا الله محمد رسول الله (Lā ʾilāha illā l-Lāh; Muḥammadu r-rasūlu l-Lāh) (Arabic, « There is no God other than God and Muhammad is His Prophet »)</b><br><br>
Drinking age: <b>Illegal everywhere in the country</b><br>
...
<a href="submit.php?country=saudi-arabia" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Saudi Arabia </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="al-amoudi-rich-regular_saudi-arabia-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/al-amoudi-rich-regular_199.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/bario-classic_200.jpeg" alt="" class="imagequery popular">
