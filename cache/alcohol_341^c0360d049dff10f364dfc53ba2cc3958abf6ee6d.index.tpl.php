...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54c94544e0c2a3_39641577',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c94544e0c2a3_39641577')) {function content_54c94544e0c2a3_39641577($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Young Master 1842 Island Imperial IPA - Beer Double IPA from Ap Lei Chau, Hong Kong</title>
        <meta name="description" content="Discover and share more Beer from Hong Kong">
		<meta name="keywords" content="Young Master 1842 Island Imperial IPA, Young Master 1842 Island Imperial IPA Young Master Hong Kong, Hong Kong Beer, Hong Kong Double IPA Beer, Young Master 1842 Island Imperial IPA 8 ABV,  World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Young Master 1842 Island Imperial IPA Beer from Ap Lei Chau, Hong Kong - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/mini/young-master-1842-island-imperial-ipa_130.jpeg"/>
		 
		<meta property="og:description" content="Discover and share more Beer from Hong Kong"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/young-master-1842-island-imperial-ipa_hong-kong-beer"/>
...
<nav class="ink-navigation">
	...
	<li><a href="http://worldofalcohols.com/hong-kong-alcohols">Hong Kong</a></li>
	
	<li class="active"><a href="#"><b>Young Master 1842 Island Imperial IPA</b></a></li>
	</ul>
	</nav>
</header>
...
<div class="column-group gutters"> 
	<div class="xlarge-15 large-15 medium-20 small-30"> 
		...
		<img width="140" src="http://worldofalcohols.com/mini/young-master-1842-island-imperial-ipa_130.jpeg" alt="" class="imagequery">
		<figcaption class="dark over-bottom">Young Master 1842 Island Imperial IPA</figcaption>
		</figure>
	</div>
...
"><?php echo $_smarty_tpl->tpl_vars['alcohol']->value['name'];?>
		...
		Type: Beer<br>
		Genre: Double IPA<br>
		Brewery: Young Master Hong Kong<br>
		Brewed in: Ap Lei Chau, Hong Kong<br><br>
		ABV: <b>8</b> %
	...
	<div class="xlarge-30 large-30 medium-50 small-100"> 
			...
			<fieldset>
				...
				<div class="control-group">
					...
					<ul class="control unstyled">
						<li class="tip" data-tip-text="+2" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb1" name="rb" rel="341" value="2"><label for="rb1" class="rating_option"><b>A piece of art !</b> My dream is to have a pool filled with this alcohol !</label></li>
						<li class="tip" data-tip-text="+1" data-tip-where="up" data-tip-color="green"><input type="radio" id="rb2" name="rb" rel="341" value="1"><label for="rb2" class="rating_option"><b>Better than average.</b> To discover with friends.</label></li>
						<li class="tip" data-tip-text="ok" data-tip-where="up" data-tip-color="orange"><input type="radio" id="rb3" name="rb" rel="341" value="0"><label for="rb3" class="rating_option"><b>I don't remember</b>, but it was a legendary night !</label></li>
						<li class="tip" data-tip-text="-1" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb4" name="rb" rel="341" value="-1"><label for="rb4" class="rating_option"><b>Drinkable</b> when you are already drunk ! </label></li>
						<li class="tip" data-tip-text="-2" data-tip-where="up" data-tip-color="red"><input type="radio" id="rb5" name="rb" rel="341" value="-2"><label for="rb5" class="rating_option"><b>I prefer water</b> !</label></li>
					</ul>
					</div>
				</div>
			</fieldset>
		...
		<h5>Do you know any other local alcohol from Hong Kong ? Feel free to share it with us </h5>
		<a href="submit.php?country=hong-kong" class="ink-button green">Submit local alcohol </a>
		</div>
	</div>
</div>
