...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ca05fe1edc72_24732988',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ca05fe1edc72_24732988')) {function content_54ca05fe1edc72_24732988($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
        <title>Czech Republic Alcohols: Discover the best alcohols (Becherovka, Beer, Slivovice) from Czech Republic</title>
        <meta name="description" content="Discover and share local Becherovka, Beer, Slivovitz from Czech Republic">
		<meta name="keywords" content="Czech Republic alcohols, alcohol Czech Republic, Becherovka Czech Republic, Beer Czech Republic, Slivovitz Czech Republic, World of alcohols, rate local alcohols, rate local beers, rate local wines, rate local whiskys">
		...
		<meta property="og:title" content="Czech Republic Alcohols: Discover best Becherovka, Beer, Slivovice from Czech Republic - WorldOfAlcohols.com"/>
		 
		<meta property="og:image" content="http://worldofalcohols.com/flags_mini/Czech.png"/>
		 
		<meta property="og:description" content="Discover and share local Becherovka, Beer, Slivovitz from Czech Republic"/>
		 
		<meta property="og:url" content="http://worldofalcohols.com/czech-republic-alcohols"/>
...
<nav class="ink-navigation">
	...
	<li class="active"><a href="#"><b>Czech Republic</b></a></li>
	</ul>
	</nav>
</header>
	...
	<div class="xlarge-15 large-15 medium-20 small-100"> 
			<nav class="ink-navigation">
				...
				<li class="heading active"><a href="#">Alcohol Types</a></li>
									<li class="menu_id">
						<a href="#Becherovka (1)" class="item_link">Becherovka (1)</a>
						<ul class="submenu">
														<li><a href="becherovka_czech-republic-becherovka">Becherovka</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Beer (3)" class="item_link">Beer (3)</a>
						<ul class="submenu">
														<li><a href="pilsner-urquell-nefiltrovany_czech-republic-beer">Pilsner Urquell Nefiltrovaný</a></li>
														<li><a href="zlata-raketa-golden-rocket-17_czech-republic-beer">Zlatá Raketa (Golden Rocket) 17°</a></li>
														<li><a href="uneticke-pivo-10-nefiltrovane_czech-republic-beer">Únetické Pivo 10° Nefiltrované</a></li>
													</ul>
					</li>
									<li class="menu_id">
						<a href="#Slivovitz (1)" class="item_link">Slivovitz (1)</a>
						<ul class="submenu">
														<li><a href="slivovica_czech-republic-slivovitz">Slivovica</a></li>
													</ul>
					</li>
								</ul>
			</nav>
...
<img src="flags_mini/Czech.png" /><br>
Capital: <b>Prague</b><br>
Population: <b>10,521,600</b><br>
<div id="country_details">
Surface: <b>78,865 km²</b><br>
Currency: <b>CZK</b><br>
Motto: <b>Pravda vítězí (Czech, « Truth prevails »)</b><br><br>
Drinking age: <b>18</b><br>
National Alcohols: <b>Becherovka, Beer, Slivovice</b><br>
</div>
</div>
	</div>
</div>
...
<a href="submit.php?country=czech-republic" class="ink-button green"> Submit local alcohol </a><br>
</div>


<h3 class="quarter-top-space"><i class='icon-trophy'></i>Popular Alcohols from Czech Republic </h3>
<div class="column-group gutters"> 
			<div class="xlarge-10 large-10 medium-15 small-25">
		<a href="zlata-raketa-golden-rocket-17_czech-republic-beer">
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/zlata-raketa-golden-rocket-17_791.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/uneticke-pivo-10-nefiltrovane_791.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/slivovica_791.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/becherovka_791.jpeg" alt="" class="imagequery popular">
		...
		<figure class="ink-image">
		<img width="140" src="http://worldofalcohols.com/mini/pilsner-urquell-nefiltrovany_791.jpeg" alt="" class="imagequery popular">
